...
Public Class ELLIB_CONTDAL
    ...
    Public Function SaveRow(ByVal ELLIB_CONTBE As ELLIB_CONTBE, ByVal flagAccion As String) As String
        ...
        Try
            ...
            If flagAccion = "N" Then
                ...
                InsertRow(ELLIB_CONTBE, cn, sqlTrans)
            End If

            If flagAccion = "M" Then
                UpdateRow(ELLIB_CONTBE, cn, sqlTrans)
            End If

            If flagAccion = "E" Then
                DeleteRow(ELLIB_CONTBE, cn, sqlTrans)
            End If
    ...
    Private Sub DeleteRow(ByVal ELLIB_CONTBE As ELLIB_CONTBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
    ...
    Private Sub InsertRow(ByVal ELLIB_CONTBE As ELLIB_CONTBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
                          ByVal sqlTrans As Oracle.ManagedDataAccess.Client.OracleTransaction)
        ...
        cmd.CommandText = "SP_LIB_CONT_INSERTROW"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        ...
        'cmd.Dispose()
    End Sub
    Private Sub UpdateRow(ByVal ELLIB_CONTBE As ELLIB_CONTBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
                          ByVal sqlTrans As Oracle.ManagedDataAccess.Client.OracleTransaction)
