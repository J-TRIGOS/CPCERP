...
Public Class BOLETADAL
    ...
    Private Sub InsertRow(ByVal BOLETABE As BOLETABE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
        ...
        cmd.CommandText = "SP_DOCUMENTO_INSERTROW_BL"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        'Los parametros que va recibir son las propiedades de la clase 
        cmd.Parameters.Add("@t_doc_ref", OracleDbType.Varchar2).Value = BOLETABE.T_DOC_REF
        cmd.Parameters.Add("@ser_doc_ref", OracleDbType.Varchar2).Value = BOLETABE.SER_DOC_REF
        cmd.Parameters.Add("@nro_doc_ref", OracleDbType.Varchar2).Value = BOLETABE.NRO_DOC_REF
        cmd.Parameters.Add("@art_cod", OracleDbType.Varchar2).Value = BOLETABE.ART_COD
        cmd.Parameters.Add("@fec_gene", OracleDbType.Date).Value = BOLETABE.FEC_GENE
        cmd.Parameters.Add("@est", OracleDbType.Varchar2).Value = BOLETABE.EST
        cmd.Parameters.Add("@moneda", OracleDbType.Varchar2).Value = BOLETABE.MONEDA
        cmd.Parameters.Add("@tprecio_venta", OracleDbType.Double).Value = BOLETABE.TPRECIO_VENTA
        cmd.Parameters.Add("@fec_anu", OracleDbType.Date).Value = BOLETABE.FEC_ANU
        cmd.Parameters.Add("@signo", OracleDbType.Varchar2).Value = BOLETABE.SIGNO
        cmd.Parameters.Add("@tprecio_dventa", OracleDbType.Double).Value = BOLETABE.TPRECIO_DVENTA
        cmd.Parameters.Add("@usuario", OracleDbType.Varchar2).Value = BOLETABE.USUARIO
        cmd.Parameters.Add("@observa", OracleDbType.Char).Value = BOLETABE.OBSERVA
        cmd.Parameters.Add("@t_movinv", OracleDbType.Char).Value = BOLETABE.T_MOVINV
        cmd.Parameters.Add("@t_igv", OracleDbType.Double).Value = BOLETABE.T_IGV
        cmd.Parameters.Add("@t_igv_dolar", OracleDbType.Double).Value = BOLETABE.T_IGV_DOLAR
        cmd.Parameters.Add("@f_pago_ent", OracleDbType.Varchar2).Value = BOLETABE.F_PAGO_ENT
        cmd.Parameters.Add("@for_ent_cod", OracleDbType.Varchar2).Value = BOLETABE.FOR_ENT_COD
        cmd.Parameters.Add("@proveedor", OracleDbType.Char).Value = BOLETABE.PROVEEDOR
        cmd.Parameters.Add("@FEC_PROV", OracleDbType.Date).Value = BOLETABE.FEC_PROV
        cmd.Parameters.Add("@ctct_cod", OracleDbType.Varchar2).Value = BOLETABE.CTCT_COD
        cmd.Parameters.Add("@vendedor", OracleDbType.Varchar2).Value = BOLETABE.VENDEDOR
        cmd.Parameters.Add("@dir_cod", OracleDbType.Varchar2).Value = BOLETABE.DIR_COD
        cmd.Parameters.Add("@NUMPEDIDO", OracleDbType.Varchar2).Value = BOLETABE.NUMPEDIDO
        cmd.Parameters.Add("@fec_dia", OracleDbType.Date).Value = BOLETABE.FEC_DIA
        'cmd.Parameters.Add("@REG_NRO", OracleDbType.Varchar2).Value = FACTURACIONBE.REG_NRO
        cmd.Parameters.Add("@X_RET", OracleDbType.Varchar2).Value = "N"
        cmd.Parameters.Add("@NOM_CTCT", OracleDbType.Varchar2).Value = BOLETABE.NOM_CTCT
        cmd.Parameters.Add("@T_CAMB", OracleDbType.Double).Value = BOLETABE.T_CAMB
        cmd.ExecuteNonQuery()
        cmd.Dispose()
        ...
        For Each row As DataGridViewRow In dg.Rows
            ...
            cmd.CommandText = "SP_DET_DOCUMENTO_INSBL"
            cmd.Connection = sqlCon
            cmd.Transaction = sqlTrans
            cmd.CommandType = CommandType.StoredProcedure
            ...
            ElseIf BOLETABE.MONEDA = "01" Then
            ...
            If BOLETABE.SER_DOC_REF = DET_DOCUMENTOBE.SER_DOC_REF1 And BOLETABE.T_DOC_REF = DET_DOCUMENTOBE.T_DOC_REF1 Then
                DET_DOCUMENTOBE.NRO_DOC_REF1 = BOLETABE.NRO_DOC_REF & "-" & cont
            End If
            'Los parametros que va recibir son las propiedades de la clase 
            cmd.Parameters.Add("@t_doc_ref", OracleDbType.Varchar2).Value = BOLETABE.T_DOC_REF
            cmd.Parameters.Add("@ser_doc_ref", OracleDbType.Varchar2).Value = BOLETABE.SER_DOC_REF
            ...
            cmd.Parameters.Add("@t_movinv", OracleDbType.Varchar2).Value = Trim(BOLETABE.T_MOVINV)
            ...
            cmd.Parameters.Add("@F_PAGO_ENT", OracleDbType.Char).Value = BOLETABE.F_PAGO_ENT
            cmd.ExecuteNonQuery()
            cmd.Dispose()
        Next
        'ACTUALIZA CABECERA
        ...
        cmd.Parameters.Add("pLOG_OBSERV", OracleDbType.Char).Value = "Se ingreso el Documento: " + BOLETABE.T_DOC_REF + "-" + BOLETABE.SER_DOC_REF + "-" + BOLETABE.NRO_DOC_REF
        cmd.ExecuteNonQuery()
        cmd.Dispose()
    End Sub

    'Metodo para Modificar 
    Private Sub UpdateRow(ByVal BOLETABE As BOLETABE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
                          ByVal sqlTrans As Oracle.ManagedDataAccess.Client.OracleTransaction, ByVal dg As DataGridView)
        'Dim contenedor As String
        Dim DAcumula As Double = 0
        Dim DAcumula1 As Double = 0
        ...
        Dim DAcumula5 As Double = 0
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        cmd.CommandText = "SP_DOCUMENTO_UPDATEROW_BL"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        'Los parametros que va recibir son las propiedades de la clase 
        ...
        cmd.Parameters.Add("@fec_dia", OracleDbType.Date).Value = BOLETABE.FEC_DIA
        'cmd.Parameters.Add("@REG_NRO", OracleDbType.Varchar2).Value = FACTURACIONBE.REG_NRO
        cmd.Parameters.Add("@X_RET", OracleDbType.Varchar2).Value = BOLETABE.X_RET
        cmd.Parameters.Add("@NOM_CTCT", OracleDbType.Varchar2).Value = BOLETABE.NOM_CTCT
        cmd.Parameters.Add("@T_CAMB", OracleDbType.Double).Value = BOLETABE.T_CAMB
        cmd.ExecuteNonQuery()
        cmd.Dispose()
        ...
        cmd = New Oracle.ManagedDataAccess.Client.OracleCommand
        cmd.CommandText = "SP_DET_DOCUMENTO_DEL_BL"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@t_doc_ref", OracleDbType.Varchar2).Value = BOLETABE.T_DOC_REF
        ...
        cmd.Parameters.Add("pLOG_CODUSU", OracleDbType.Char).Value = ELMVLOGSBE.log_codusu
        cmd.Parameters.Add("pLOG_OBSERV", OracleDbType.Char).Value = "Se actualizo el Documento: " + BOLETABE.T_DOC_REF + "-" + BOLETABE.SER_DOC_REF + "-" + BOLETABE.NRO_DOC_REF
        cmd.ExecuteNonQuery()
        cmd.Dispose()

    End Sub
    Private Sub UpdateRowAnularBL(ByVal BOLETABE As BOLETABE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
                          ByVal sqlTrans As Oracle.ManagedDataAccess.Client.OracleTransaction, ByVal dg As DataGridView)
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        cmd.CommandText = "SP_DOCUMENTO_UPDATEROW_ANUBL"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure

        cmd.Parameters.Add("pt_doc_ref", OracleDbType.Varchar2).Value = Trim(BOLETABE.T_DOC_REF)
        cmd.Parameters.Add("pser_doc_ref", OracleDbType.Varchar2).Value = Trim(BOLETABE.SER_DOC_REF)
        cmd.Parameters.Add("pnro_doc_ref", OracleDbType.Varchar2).Value = Trim(BOLETABE.NRO_DOC_REF)
        cmd.Parameters.Add("pest", OracleDbType.Varchar2).Value = "A"
        cmd.ExecuteNonQuery()
        cmd.Dispose()

        cmd = New Oracle.ManagedDataAccess.Client.OracleCommand
        cmd.CommandText = "SP_DET_DOCU_UPD_ANULAR_BL"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@t_doc_ref", OracleDbType.Varchar2).Value = Trim(BOLETABE.T_DOC_REF)
        cmd.Parameters.Add("@ser_doc_ref", OracleDbType.Varchar2).Value = Trim(BOLETABE.SER_DOC_REF)
        cmd.Parameters.Add("@nro_doc_ref", OracleDbType.Varchar2).Value = Trim(BOLETABE.NRO_DOC_REF)
        cmd.Parameters.Add("pest", OracleDbType.Varchar2).Value = "A"
        cmd.ExecuteNonQuery()
        cmd.Dispose()
        ...
        cmd.Parameters.Add("pLOG_CODUSU", OracleDbType.Char).Value = ELMVLOGSBE.log_codusu
        cmd.Parameters.Add("pLOG_OBSERV", OracleDbType.Char).Value = "Se Anulo la FC: " + BOLETABE.T_DOC_REF + "-" + BOLETABE.SER_DOC_REF + "-" + BOLETABE.NRO_DOC_REF
        cmd.ExecuteNonQuery()
        cmd.Dispose()
    End Sub
    ...
    Public Function SaveRow(ByVal BOLETABE As BOLETABE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE,
        ...
        Try
            ...
            If flagAccion = "N" Then
                ...
                InsertRow(BOLETABE, DET_DOCUMENTOBE, ELMVLOGSBE, cn, sqlTrans, dg)
                'grabar acceso a los menues
            End If

            If flagAccion = "M" Then
                UpdateRow(BOLETABE, DET_DOCUMENTOBE, ELMVLOGSBE, cn, sqlTrans, dg)
            End If
            If flagAccion = "AR" Then
                UpdateRowAnularBL(BOLETABE, DET_DOCUMENTOBE, ELMVLOGSBE, cn, sqlTrans, dg)
            End If
    ...
    Public Function SelectAll(ByVal sT_doc As String, ByVal sAño As String, ByVal sMes As String) As DataTable
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As Oracle.ManagedDataAccess.Client.OracleDataReader = Me.GetDataReader("SP_DOCUMENTO_SELECTALL_BOL", {New Oracle.ManagedDataAccess.Client.OracleParameter("@t_doc_ref", sT_doc),
    ...
    Public Function SelectRow(ByVal sT_doc As String, ByVal sS_doc As String, ByVal sN_doc As String) As DataTable
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As Oracle.ManagedDataAccess.Client.OracleDataReader = Me.GetDataReader("SP_DOCUMENTO_SelectRow_BL", {New Oracle.ManagedDataAccess.Client.OracleParameter("@T_DOC_REF", sT_doc),
                                                                                                                   New Oracle.ManagedDataAccess.Client.OracleParameter("@SER_DOC_REF", sS_doc),
                                                                                                                   New Oracle.ManagedDataAccess.Client.OracleParameter("@NRO_DOC_REF", sN_doc)})
            If dr.HasRows Then
                dt.Load(dr)
    ...
    Public Function getTxtFc(ByVal sT_doc As String, ByVal sS_doc As String, ByVal sN_doc As String, ByVal sEST As String) As String
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As Oracle.ManagedDataAccess.Client.OracleDataReader = Me.GetDataReader("SP_DOCUMENTO_TXTBL", {New Oracle.ManagedDataAccess.Client.OracleParameter("@pT_DOC_REF", Trim(sT_doc)),
    ...
    Public Function getTxtFc1(ByVal sT_doc As String, ByVal sS_doc As String, ByVal sN_doc As String, ByVal sEST As String) As String
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As Oracle.ManagedDataAccess.Client.OracleDataReader = Me.GetDataReader("SP_DOCUMENTO_TXTBLX", {New Oracle.ManagedDataAccess.Client.OracleParameter("@pT_DOC_REF", Trim(sT_doc)),
                                                                                                               New Oracle.ManagedDataAccess.Client.OracleParameter("@pSER_DOC_REF", Trim(sN_doc)),
                                                                                                               New Oracle.ManagedDataAccess.Client.OracleParameter("@pNRO_DOC_REF", Trim(sS_doc)),
                                                                                                               New Oracle.ManagedDataAccess.Client.OracleParameter("@pEST", Trim(sEST))})
            While dr.Read
    ...
    Public Function AsientoFC(ByVal flagAccion As String, ByVal sAño As String, ByVal sMes As String, ByVal sNro As String, ByVal sSer As String, ByVal sTipo As String) As String
        ...
        Try
            ...
            If flagAccion = "Asiento" Then
                Asiento(cn, sqlTrans, sAño, sMes, sNro, sSer, sTipo)
            End If
    ...
    Public Sub Asiento(ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
                          ByVal sqlTrans As Oracle.ManagedDataAccess.Client.OracleTransaction, ByVal sAño As String, ByVal sMes As String, ByVal sNro As String, ByVal sSer As String, ByVal sTipo As String)
