...
Public Class NOTACREDITODAL
    ...
    Private Sub InsertRow(ByVal NOTACREDITOBE As NOTACREDITOBE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
        ...
        cmd.CommandText = "SP_DOCUMENTO_INSERTROW_NC"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        'Los parametros que va recibir son las propiedades de la clase 
        cmd.Parameters.Add("@t_doc_ref", OracleDbType.Varchar2).Value = NOTACREDITOBE.T_DOC_REF
        cmd.Parameters.Add("@ser_doc_ref", OracleDbType.Varchar2).Value = NOTACREDITOBE.SER_DOC_REF
        cmd.Parameters.Add("@nro_doc_ref", OracleDbType.Varchar2).Value = NOTACREDITOBE.NRO_DOC_REF
        cmd.Parameters.Add("@art_cod", OracleDbType.Varchar2).Value = NOTACREDITOBE.ART_COD
        cmd.Parameters.Add("@fec_gene", OracleDbType.Date).Value = NOTACREDITOBE.FEC_GENE
        cmd.Parameters.Add("@est", OracleDbType.Varchar2).Value = NOTACREDITOBE.EST
        cmd.Parameters.Add("@moneda", OracleDbType.Varchar2).Value = NOTACREDITOBE.MONEDA
        cmd.Parameters.Add("@tprecio_venta", OracleDbType.Double).Value = NOTACREDITOBE.TPRECIO_VENTA
        cmd.Parameters.Add("@fec_anu", OracleDbType.Date).Value = NOTACREDITOBE.FEC_ANU
        cmd.Parameters.Add("@signo", OracleDbType.Varchar2).Value = NOTACREDITOBE.SIGNO
        cmd.Parameters.Add("@tprecio_dventa", OracleDbType.Double).Value = NOTACREDITOBE.TPRECIO_DVENTA
        cmd.Parameters.Add("@usuario", OracleDbType.Varchar2).Value = NOTACREDITOBE.USUARIO
        cmd.Parameters.Add("@observa", OracleDbType.Char).Value = NOTACREDITOBE.OBSERVA
        cmd.Parameters.Add("@t_movinv", OracleDbType.Char).Value = NOTACREDITOBE.T_MOVINV
        cmd.Parameters.Add("@t_igv", OracleDbType.Double).Value = NOTACREDITOBE.T_IGV
        cmd.Parameters.Add("@t_igv_dolar", OracleDbType.Double).Value = NOTACREDITOBE.T_IGV_DOLAR
        cmd.Parameters.Add("@f_pago_ent", OracleDbType.Varchar2).Value = NOTACREDITOBE.F_PAGO_ENT
        cmd.Parameters.Add("@for_ent_cod", OracleDbType.Varchar2).Value = NOTACREDITOBE.FOR_ENT_COD
        cmd.Parameters.Add("@proveedor", OracleDbType.Char).Value = NOTACREDITOBE.PROVEEDOR
        cmd.Parameters.Add("@FEC_PROV", OracleDbType.Date).Value = NOTACREDITOBE.FEC_PROV
        cmd.Parameters.Add("@ctct_cod", OracleDbType.Varchar2).Value = NOTACREDITOBE.CTCT_COD
        cmd.Parameters.Add("@vendedor", OracleDbType.Varchar2).Value = NOTACREDITOBE.VENDEDOR
        cmd.Parameters.Add("@dir_cod", OracleDbType.Varchar2).Value = NOTACREDITOBE.DIR_COD
        cmd.Parameters.Add("@NUMPEDIDO", OracleDbType.Varchar2).Value = NOTACREDITOBE.NUMPEDIDO
        cmd.Parameters.Add("@fec_dia", OracleDbType.Date).Value = NOTACREDITOBE.FEC_DIA
        'cmd.Parameters.Add("@REG_NRO", OracleDbType.Varchar2).Value = NOTACREDITOBE.REG_NRO
        'cmd.Parameters.Add("@X_RET", OracleDbType.Varchar2).Value = NOTACREDITOBE.X_RET
        cmd.Parameters.Add("@MOT_COD", OracleDbType.Varchar2).Value = NOTACREDITOBE.MOT_COD
        cmd.Parameters.Add("@NOM_CTCT", OracleDbType.Varchar2).Value = NOTACREDITOBE.NOM_CTCT
        cmd.ExecuteNonQuery()
        cmd.Dispose()
        ...
        For Each row As DataGridViewRow In dg.Rows
            ...
            cmd.CommandText = "SP_DET_DOCUMENTO_INSNC"
            cmd.Connection = sqlCon
            cmd.Transaction = sqlTrans
            cmd.CommandType = CommandType.StoredProcedure
            ...
            If NOTACREDITOBE.MONEDA = "00" Then
            ...
            ElseIf NOTACREDITOBE.MONEDA = "01" Then
                ...
                DET_DOCUMENTOBE.TPRECIO_VENTA = Math.Round(DET_DOCUMENTOBE.UPRECIO_DVENTA * DET_DOCUMENTOBE.CANTIDAD * DET_DOCUMENTOBE.T_CAMB, 6)
                If NOTACREDITOBE.T_IGV > 0 Then
                    DET_DOCUMENTOBE.IGV_IMPOR = Math.Round((DET_DOCUMENTOBE.TPRECIO_VENTA * 18) / 100, 2)
                    DET_DOCUMENTOBE.IGV_DIMPOR = Math.Round((DET_DOCUMENTOBE.TPRECIO_DVENTA * 18) / 100, 2)
                Else
            ...
            If IIf(IsDBNull(RTrim(row.Cells("FECHA").Value)), "", RTrim(row.Cells("FECHA").Value)) <> "" Then
                DET_DOCUMENTOBE.FEC_ENT = IIf(IsDBNull(RTrim(row.Cells("FECHA").Value)), "", RTrim(row.Cells("FECHA").Value))
            End If
            ...
            If NOTACREDITOBE.SER_DOC_REF = DET_DOCUMENTOBE.SER_DOC_REF1 And NOTACREDITOBE.T_DOC_REF = DET_DOCUMENTOBE.T_DOC_REF1 Then
                DET_DOCUMENTOBE.NRO_DOC_REF1 = NOTACREDITOBE.NRO_DOC_REF & "-" & cont
            End If
            ...
            cmd.Parameters.Add("@t_movinv", OracleDbType.Varchar2).Value = Trim(NOTACREDITOBE.T_MOVINV)
            ...
            cmd.Parameters.Add("@NRO_DOCU2", OracleDbType.Char).Value = DET_DOCUMENTOBE.NRO_DOCU2
            cmd.Parameters.Add("@CONFIGURACION", OracleDbType.Char).Value = DET_DOCUMENTOBE.CONFIGURACION
        ...
        cmd.Parameters.Add("pLOG_OBSERV", OracleDbType.Char).Value = "Se ingreso el Documento: " + NOTACREDITOBE.T_DOC_REF + "-" + NOTACREDITOBE.SER_DOC_REF + "-" + NOTACREDITOBE.NRO_DOC_REF
        cmd.ExecuteNonQuery()
        cmd.Dispose()
    End Sub

    'Metodo para Modificar 
    Private Sub UpdateRow(ByVal NOTACREDITOBE As NOTACREDITOBE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
                          ByVal sqlTrans As Oracle.ManagedDataAccess.Client.OracleTransaction, ByVal dg As DataGridView)
        'Dim contenedor As String
        Dim DAcumula As Double = 0
        Dim DAcumula1 As Double = 0
        ...
        Dim DAcumula5 As Double = 0
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        cmd.CommandText = "SP_DOCUMENTO_UPDATEROW_NC"
        cmd.Connection = sqlCon
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        'Los parametros que va recibir son las propiedades de la clase 
        ...
        For Each row As DataGridViewRow In dg.Rows
            ...
            If NOTACREDITOBE.MONEDA = "00" Then
                DET_DOCUMENTOBE.UPRECIO_VENTA = CDbl(IIf(IsDBNull(RTrim(row.Cells("UPRECIO_VENTA").Value)), 0, RTrim(row.Cells("UPRECIO_VENTA").Value)))
                DET_DOCUMENTOBE.UPRECIO_DVENTA = Math.Round(DET_DOCUMENTOBE.UPRECIO_VENTA / DET_DOCUMENTOBE.T_CAMB, 6)
                DET_DOCUMENTOBE.TPRECIO_VENTA = Math.Round(DET_DOCUMENTOBE.UPRECIO_VENTA * DET_DOCUMENTOBE.CANTIDAD, 6)
                DET_DOCUMENTOBE.TPRECIO_DVENTA = Math.Round(DET_DOCUMENTOBE.UPRECIO_VENTA * DET_DOCUMENTOBE.CANTIDAD / DET_DOCUMENTOBE.T_CAMB, 2)
                If NOTACREDITOBE.T_IGV > 0 Then
                    DET_DOCUMENTOBE.IGV_IMPOR = Math.Round((DET_DOCUMENTOBE.TPRECIO_VENTA * 18) / 100, 2)
                    DET_DOCUMENTOBE.IGV_DIMPOR = Math.Round((DET_DOCUMENTOBE.TPRECIO_DVENTA * 18) / 100, 2)
            ...
            ElseIf NOTACREDITOBE.MONEDA = "01" Then
                DET_DOCUMENTOBE.UPRECIO_DVENTA = Math.Round(CDbl(IIf(IsDBNull(RTrim(row.Cells("UPRECIO_DVENTA").Value)), 0, RTrim(row.Cells("UPRECIO_DVENTA").Value))), 3)
                DET_DOCUMENTOBE.UPRECIO_VENTA = Math.Round(DET_DOCUMENTOBE.UPRECIO_DVENTA * DET_DOCUMENTOBE.T_CAMB, 3)
                DET_DOCUMENTOBE.TPRECIO_DVENTA = Math.Round(DET_DOCUMENTOBE.UPRECIO_DVENTA * DET_DOCUMENTOBE.CANTIDAD, 2)
        ...
        cmd.Parameters.Add("pLOG_CODUSU", OracleDbType.Char).Value = ELMVLOGSBE.log_codusu
        cmd.Parameters.Add("pLOG_OBSERV", OracleDbType.Char).Value = "Se actualizo el Documento: " + NOTACREDITOBE.T_DOC_REF + "-" + NOTACREDITOBE.SER_DOC_REF + "-" + NOTACREDITOBE.NRO_DOC_REF
        cmd.ExecuteNonQuery()
        cmd.Dispose()

    End Sub
    Private Sub UpdateRowAnularFC(ByVal NOTACREDITOBE As NOTACREDITOBE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE, ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection,
                          ByVal sqlTrans As Oracle.ManagedDataAccess.Client.OracleTransaction, ByVal dg As DataGridView)
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        ...
        cmd.Parameters.Add("pt_doc_ref", OracleDbType.Varchar2).Value = Trim(NOTACREDITOBE.T_DOC_REF)
        cmd.Parameters.Add("pser_doc_ref", OracleDbType.Varchar2).Value = Trim(NOTACREDITOBE.SER_DOC_REF)
        cmd.Parameters.Add("pnro_doc_ref", OracleDbType.Varchar2).Value = Trim(NOTACREDITOBE.NRO_DOC_REF)
        ...
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@t_doc_ref", OracleDbType.Varchar2).Value = Trim(NOTACREDITOBE.T_DOC_REF)
        cmd.Parameters.Add("@ser_doc_ref", OracleDbType.Varchar2).Value = Trim(NOTACREDITOBE.SER_DOC_REF)
        cmd.Parameters.Add("@nro_doc_ref", OracleDbType.Varchar2).Value = Trim(NOTACREDITOBE.NRO_DOC_REF)
        cmd.Parameters.Add("pest", OracleDbType.Varchar2).Value = "A"
        cmd.ExecuteNonQuery()
        cmd.Dispose()
        ...
        cmd.Parameters.Add("pLOG_CODUSU", OracleDbType.Char).Value = ELMVLOGSBE.log_codusu
        cmd.Parameters.Add("pLOG_OBSERV", OracleDbType.Char).Value = "Se Anulo la NC: " + NOTACREDITOBE.T_DOC_REF + "-" + NOTACREDITOBE.SER_DOC_REF + "-" + NOTACREDITOBE.NRO_DOC_REF
        cmd.ExecuteNonQuery()
        cmd.Dispose()
    End Sub
    ...
    Public Function SaveRow(ByVal NOTACREDITOBE As NOTACREDITOBE, ByVal DET_DOCUMENTOBE As DET_DOCUMENTOBE, ByVal ELMVLOGSBE As ELMVLOGSBE,
        ...
        Try
            ...
            If flagAccion = "N" Then
                ...
                InsertRow(NOTACREDITOBE, DET_DOCUMENTOBE, ELMVLOGSBE, cn, sqlTrans, dg)
                'grabar acceso a los menues
            End If

            If flagAccion = "M" Then
                UpdateRow(NOTACREDITOBE, DET_DOCUMENTOBE, ELMVLOGSBE, cn, sqlTrans, dg)
            End If
            If flagAccion = "AR" Then
                UpdateRowAnularFC(NOTACREDITOBE, DET_DOCUMENTOBE, ELMVLOGSBE, cn, sqlTrans, dg)
            End If
    ...
    Public Function getListdgv2(ByVal sT_doc As String, ByVal sS_doc As String, ByVal sN_doc As String) As DataTable
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As OracleDataReader = Me.GetDataReader("SP_DET_DOCUMENTO_SELNC", {New Oracle.ManagedDataAccess.Client.OracleParameter("@t_doc_ref", sT_doc),
                                                                                        New Oracle.ManagedDataAccess.Client.OracleParameter("@ser_doc_ref", sS_doc),
                                                                                        New Oracle.ManagedDataAccess.Client.OracleParameter("@nro_doc_ref", sN_doc)})
            If dr.HasRows Then
                dt.Load(dr)
    ...
    Public Function getTxtFc(ByVal sT_doc As String, ByVal sS_doc As String, ByVal sN_doc As String, ByVal sEst As String) As String
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As Oracle.ManagedDataAccess.Client.OracleDataReader = Me.GetDataReader("SP_DOCUMENTO_TXTNCX1", {New Oracle.ManagedDataAccess.Client.OracleParameter("@pT_DOC_REF", Trim(sT_doc)),
    ...
    Public Function getTxtFc1(ByVal sT_doc As String, ByVal sS_doc As String, ByVal sN_doc As String, ByVal sEst As String) As String
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As Oracle.ManagedDataAccess.Client.OracleDataReader = Me.GetDataReader("SP_DOCUMENTO_TXTNCX", {New Oracle.ManagedDataAccess.Client.OracleParameter("@pT_DOC_REF", Trim(sT_doc)),
                                                                                                               New Oracle.ManagedDataAccess.Client.OracleParameter("@pSER_DOC_REF", Trim(sN_doc)),
                                                                                                               New Oracle.ManagedDataAccess.Client.OracleParameter("@pNRO_DOC_REF", Trim(sS_doc)),
                                                                                                               New Oracle.ManagedDataAccess.Client.OracleParameter("@pEST", Trim(sEst))})
            While dr.Read
    ...
    Public Function SaveRowEst(ByVal NOTACREDITOBE As NOTACREDITOBE, ByVal ELMVLOGSBE As ELMVLOGSBE,
        ...
        Try
            ...
            If flagAccion = "ACTEST" Then
                ActReg(cn, NOTACREDITOBE, ELMVLOGSBE, sqlTrans)
            End If
            sqlTrans.Commit()
            resultado = "OK"
    ...
    End Function
    Public Sub ActReg(ByVal sqlCon As Oracle.ManagedDataAccess.Client.OracleConnection, ByVal NOTACREDITOBE As NOTACREDITOBE, ByVal ELMVLOGSBE As ELMVLOGSBE,
        ...
        cmd.Transaction = sqlTrans
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add("@sT_DOC_REF", OracleDbType.Varchar2).Value = NOTACREDITOBE.T_DOC_REF
        cmd.Parameters.Add("@sSER_DOC_REF", OracleDbType.Varchar2).Value = NOTACREDITOBE.SER_DOC_REF
        cmd.Parameters.Add("@sNRO_DOC_REF", OracleDbType.Varchar2).Value = NOTACREDITOBE.NRO_DOC_REF
        cmd.Parameters.Add("@sX_D", OracleDbType.Varchar2).Value = NOTACREDITOBE.X_D
        cmd.ExecuteNonQuery()
        cmd.Dispose()
    ...
    Public Function SelectEstRecogido(ByVal sAño As String, ByVal sMes As String) As DataTable
        Dim cmd As New Oracle.ManagedDataAccess.Client.OracleCommand
        Dim dt As New DataTable
        Using dr As Oracle.ManagedDataAccess.Client.OracleDataReader = Me.GetDataReader("SP_DOCUMENTO_SELALL_NC_ESTREC", {New Oracle.ManagedDataAccess.Client.OracleParameter("@fec_gene", sAño),
                                                                                        New Oracle.ManagedDataAccess.Client.OracleParameter("@mes", sMes)})
            If dr.HasRows Then
                dt.Load(dr)
            End If
