    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If rdbfacturas.Checked = True Then
            If rdbnum.Checked = True Then
                ...
                Else
                    ...
                    gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTDET_DOCU_VENTAS.rpt"
                    gsRptPath = gsPathRpt
            ...
            Else
                ...
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTDET_DOCU_VEN_CTCT.rpt"
                gsRptPath = gsPathRpt
                FormReportes.ShowDialog()
            End If
        ElseIf rdbfacturasn.Checked = True Then
            If rdbnum.Checked = True Then
                ...
                gsRptArgs(0) = txtnumero.Text
                gsRptArgs(1) = txtcliente1.Text
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTDET_DOCU_VENTAS1.rpt"
                gsRptPath = gsPathRpt
                FormReportes.ShowDialog()
            ElseIf rdbaño.Checked = True Then
                ...
                gsRptArgs(1) = cmbaño.Text
                gsRptArgs(2) = cmbaño2.Text
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTDET_DOCU_VEN_CTCT2.rpt"
                gsRptPath = gsPathRpt
                FormReportes.ShowDialog()
            ...
            ElseIf rdbañomes.Checked = True Then
                ...
                End If
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTDET_DOCU_VEN_CTCT3.rpt"
                gsRptPath = gsPathRpt
                FormReportes.ShowDialog()
            End If
        End If
