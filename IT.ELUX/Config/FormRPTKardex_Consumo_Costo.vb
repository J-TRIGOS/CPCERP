...
#End Region
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If rdbccosto.Checked Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_KARDEX_CONSUMO_CCOSTO_RESU_.rpt"
                gsRptPath = gsPathRpt
            ...
            gsRptArgs(7) = Mid(cmbtipo.Text, 1, 3)
            gsRptArgs(8) = Mid(cmbtipo2.Text, 1, 3)
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_KARDEX_CONSUMO_RESU.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
