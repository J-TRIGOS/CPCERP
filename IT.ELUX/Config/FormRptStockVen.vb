Public Class FormRptStockVen
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        If CheckBox1.Checked Then
            gsRptArgs(0) = "0218"
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_EL_TBARTSTOCK_T_ENVART.rpt"
        Else
            gsRptArgs(0) = txtvend.Text

            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_EL_TBARTSTOCK_T_ENVVEN.rpt"
        End If
        gsRptPath = gsPathRpt
