...
#End Region
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If rdbpp.Checked = True Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_KARDEX__PARTES_MEDIDA_RESU.rpt"
            gsRptPath = gsPathRpt
        ...
        ElseIf rdbsinpp.Checked = True Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_KARDEX_MEDIDA_RESU.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        ElseIf rdbppv.Checked = True Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_KARDEX_CONSUMO_AHB_CCOSTO_RESU.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
