...
Public Class FormMantCosteoArt
    ...
    Private Sub btnprocesar1_Click(sender As Object, e As EventArgs) Handles btnprocesar1.Click
        ...
        If dgvt_art.Rows.Count > 0 Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_ELTBARTCOST_ARTMP1.rpt"
            gsRptPath = gsPathRpt
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_ELTBARTCOST_ARTMP2.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
