...
#End Region
    ...
    Private Function OkData() As Boolean
        ...
        If gsUser <> "SISTEMA" Then
            ...
            End If
        End If
        If cmb_serdoc.Text = "T001" Then
            MsgBox("No se puede Generar documento ni actualizar con esta serie T001 ya que es solo para traslados", MsgBoxStyle.Exclamation)
            txtc_costo.Focus()
            Return False
        End If
        Return True
    ...
    Private Sub SaveData()
        ...
        Try
            ...
            If flagAccion = "N" Then
                If txtt_movinv.Text = "E18" Or txtt_movinv.Text = "S30" Then
                    If cmb_serdoc.SelectedIndex <> 16 Then
                        ...
                        For i = 0 To dgvt_doc.Rows.Count - 1
                            dgvt_doc.Rows(dgvt_doc.CurrentRow.Index).Cells("NRO_DOC_REF1").Value = nro1.PadLeft(7, "0")
                            dgvt_doc.Rows(dgvt_doc.CurrentRow.Index).Cells("SER_DOC_REF1").Value = "T001"
                        Next
                    End If
            ...
            Else
                If txtt_movinv.Text = "E18" Or txtt_movinv.Text = "S30" Then
                    gsError = GUIAALMACENBL.SaveRow(GUIAALMACENBE, DET_DOCUMENTOBE, ELMVALMABE, ELMVLOGSBE, "TRANS", dgvt_doc, "T001", dgvt_doc.Rows(0).Cells("NRO_DOC_REF1").Value)
                    If gsError = "OK" Then
        ...
        Select Case sFunc
            ...
            Case "Print"
                ...
                If txtt_movinv.Text = "S30" Or txtt_movinv.Text = "E18" Then
                    gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_VALE_TRASLADO.rpt"
                Else
    ...
    Private Sub FormMantGuiaAlmacen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dgvt_doc.Columns.Add("ART_COD2", "Cod. Art.2") '45
        dgvt_doc.Columns.Add("ART_VENTA", "Activos 2") '46
        dgvt_doc.Columns.Add("cantidad3", "cantidad3") '47
        '------------------------------------------
        ...
        Select Case gnOpcion
            Case 0
                ...
                txtproveedor.Text = "20100279348"
                cmbproveedor.SelectedValue = "20100279348"
            Case 1
                flagAccion = "M"
                ...
                For Each row As DataRow In dtArticulo.Rows
                    ...
                    dgvt_doc.Rows.Add(IIf(IsDBNull(row("T_DOC_REF")), "", row("T_DOC_REF")), '0
                                      ...
                                      IIf(IsDBNull(row("ART_COD1")), "", row("ART_COD1")), '45
                                      IIf(IsDBNull(row("ART_VENTA")), "", row("ART_VENTA")), '46
                                      IIf(IsDBNull(row("CANTIDAD3")), "", row("CANTIDAD3"))) '47
                Next
                Dim i As Integer
                For i = 0 To 44
                    If i <> 34 Then
