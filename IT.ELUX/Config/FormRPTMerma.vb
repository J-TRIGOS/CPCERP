...
Public Class FormRPTMerma
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        ''        End If
        ''        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_RPTSEGMERMA_PRO.rpt"
        ''        gsRptPath = gsPathRpt
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        ElseIf txtSubLin1.Text = "0207" Or txtSubLin1.Text = "0210" Or txtSubLin1.Text = "0208" Then
            pAREA = "LT" 'LITOGRAFIA
        ElseIf txtSubLin1.Text = "0101" Or txtSubLin1.Text = "0102" Or txtSubLin1.Text = "1003" Then
            pAREA = "FC" 'FIBRA CARTON
        ElseIf txtSubLin1.Text = "1003" Then
            pAREA = "CN" 'CARTON
        ...
        If plINEA1 = "LINEA" Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_RPTSEGMERMA_PRO_2.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        Else
            gsRptArgs = {}
