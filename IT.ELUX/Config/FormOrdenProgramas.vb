    ...
    Private Sub tsbForm_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles tsbForm.ItemClicked
        ...
        Select Case sFunc
            ...
            Case "pr"
                ...
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_RPTORDEN_PROGRAM_SELROW3.rpt"
                gsRptPath = gsPathRpt
            ...
            Case "Print"
                ...
                gsRptArgs(0) = RTrim(txtdocumento.Text.Substring(0, 4))
                gsRptArgs(1) = RTrim(txtdocumento.Text.Substring(7, 7))
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_RPTORDEN_PROGRAM_SELROW2.rpt"
                gsRptPath = gsPathRpt
                FormReportes.ShowDialog()
                Exit Sub
        End Select
