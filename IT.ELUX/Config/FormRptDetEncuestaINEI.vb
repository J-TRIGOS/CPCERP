Public Class FormRptDetEncuestaINEI
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        If gsCode10 = "1" Then 'detallado
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_RPTENCUESTADETINEI.rpt"
        ElseIf gsCode10 = "2" Then 'resumen
            gsRptArgs(0) = cmbaño.Text
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_ESTADISTICO_PER.rpt"
        End If
