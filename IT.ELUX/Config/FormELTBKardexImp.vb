...
Public Class FormELTBKardexImp
    ...
    Private Sub FormELTBKardexImp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dgvt_doc.Columns.Add("T_CMB", "TIPO CAMBIO") '18
        ...
        Try
            ...
            Select Case sFunc
                ...
                Case "Print"
                    ...
                    gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_IMPRESION_FC.rpt"
                    gsRptPath = gsPathRpt
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        frm.dgvt_doc2.Columns.Add("Peso_Total", "Peso Total") '20
        frm.dgvt_doc2.Columns.Add("TIPO", "TIPO") '20
        ...
        Else
            For i = 0 To dgvt_doc.Rows.Count - 1
                frm.dgvt_doc2.Rows.Add(dgvt_doc.Rows(i).Cells("T_DOC_REF").Value,
                                       ...
                                       dgvt_doc.Rows(i).Cells("CANTIDAD").Value * dgvt_doc.Rows(i).Cells("UPRECIO_COMPRA").Value)
            Next
        End If
