        ...
        For i = 0 To dgvt_doc.Rows.Count - 1
            ...
            If txtmon.Text = "00" Then
                creacion = creacion & "<tr> <td> Articulo Venta (Sin IGV.) " & i + 1 & ":</td>
                        ...
                        CANTIDAD:" & Val(dgvt_doc.Rows(i).Cells("CANTIDAD").Value) & "<br>IMPORTE:" & Val(dgvt_doc.Rows(i).Cells("TPRECIO_VENTA").Value) & "</td>
                        </tr>"
            Else
                creacion = creacion & "<tr> <td>  Articulo Venta (Sin IGV.) " & i + 1 & ":</td>
                        <td>" & dgvt_doc.Rows(i).Cells("ART_COD").Value & "-" & dgvt_doc.Rows(i).Cells("NOM_ART").Value & " <br>
                        CANTIDAD:" & Val(dgvt_doc.Rows(i).Cells("CANTIDAD").Value) & "<br>IMPORTE:" & Val(dgvt_doc.Rows(i).Cells("TPRECIO_DVENTA").Value) & "</td>
                        </tr>"
            End If
        Next
        Return creacion
    ...
    Private Sub tsbForm_ItemClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolStripItemClickedEventArgs) Handles tsbForm.ItemClicked
        ...
        Select Case sFunc
            ...
            Case "Print"
                ...
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_ORDEN82.rpt"
                gsRptPath = gsPathRpt
