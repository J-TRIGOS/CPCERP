...
#End Region
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_FACT_ADELA_PEND.rpt"
        gsRptPath = gsPathRpt
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_FACT_ADELA.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_FACT_ADELA_PEND_ART.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
End Class