...
Public Class FormMantELTBRECC
    ...
    Private Sub GetCmb()
        ...
        dtUsuario = ELTBCARABL.SelectDescripcion()
    ...
    Private Sub FormMantELTBRECC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        gsError = ""
    ...
    Private Sub btnagregar_Click(sender As Object, e As EventArgs) Handles btnagregar.Click
        ...
        FormMantELTBCATA.dgvCaracteristica.Rows.Add(txtcodigo.Text, cmbdescripcion.Text)
        Dispose()
    End Sub
