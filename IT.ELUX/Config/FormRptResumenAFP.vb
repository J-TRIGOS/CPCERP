...
Public Class FormRptResumenAFP
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RESUMEN_AFP.rpt"
        gsRptPath = gsPathRpt
    ...
    Private Sub btnreporte1_Click(sender As Object, e As EventArgs) Handles btnreporte1.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_HOJA_TRAB_AFP.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub btnreporte2_Click(sender As Object, e As EventArgs) Handles btnreporte2.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_TEXTO_AFP.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
