...
Public Class FormSolmOrden
    ...
    Private Sub SaveData()
        ...
        For i = 0 To dgvsolm.Rows.Count - 1
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SOLM1.rpt"
            gsRptPath = gsPathRpt
            ...
            For i = 0 To lvbusqueda.Items.Count - 1
                If lvbusqueda.Items(i).Checked Then
                    ...
                    If Mid(a, 1, 3) = "ENS" Then
                        ...
                        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_CONTROL_TIEMPO_ENS1.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                        'End If
                    ElseIf Mid(a, 1, 3) = "LIT" Then
                        ...
                        gsRptArgs(1) = lblsdoc.Text
                        gsRptArgs(2) = lvbusqueda.Items(i).SubItems(0).Text
                        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_CONTROL_TIEMPO_LIT1.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                        'End If
                    ElseIf Mid(a, 1, 3) = "PRE" Then
                        ...
                        gsRptArgs(1) = lblsdoc.Text
                        gsRptArgs(2) = lvbusqueda.Items(i).SubItems(0).Text
                        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_CONTROL_TIEMPO_TMPPRE1.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                        'End If
