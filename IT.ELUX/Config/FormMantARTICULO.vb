...
#End Region
    ...
    Private Sub FormMntArticulo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sPath As String = gsIpserver & "sistema\E.LUX\IMAGENES\"
    ...
    Private Sub cmbcatalogo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbcatalogo.SelectedIndexChanged
        ...
        If MessageBox.Show("Esta seguro de Cambiar de Catalogo",
                           gpCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question,
                           MessageBoxDefaultButton.Button1) <> DialogResult.Yes Then
            Exit Sub
        End If
    ...
    Private Sub btnimprimir_Click(sender As Object, e As EventArgs) Handles btnimprimir.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_ART_CAR_DATO.rpt"
        gsRptPath = gsPathRpt
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If Mid(txtdescriproc.Text, 1, 3) = "ENS" Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_CONTROL_TIEMPO_ENS.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
            'End If
        ElseIf Mid(txtdescriproc.Text, 1, 3) = "LIT" Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_CONTROL_TIEMPO_LIT.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
            'End If
        ElseIf Mid(txtdescriproc.Text, 1, 3) = "PRE" Then
            ...
            gsRptArgs(1) = txtartcodigo.Text
            gsRptArgs(2) = cmbcentrocosto.SelectedValue
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_CONTROL_TIEMPO_TMPPRE.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
            'End If
        ElseIf Mid(txtdescriproc.Text, 1, 3) = "COR" Then
            ...
            gsRptArgs(1) = txtartcodigo.Text
            gsRptArgs(2) = cmbcentrocosto.SelectedValue
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_CONTROL_TIEMPO_TMPCOR.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
            'End If
        End If
