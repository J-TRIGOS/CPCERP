...
Public Class FormRPTLetrasCambio
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If rdbletra.Checked Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_LETRAS_CAMBIO.rpt"
            gsRptPath = gsPathRpt
        ...
        Else
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_LETRAS_CAMBIO_FC.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
    ...
    Private Sub btnreporte3_Click(sender As Object, e As EventArgs) Handles btnreporte3.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_LETRAS_COMPRAS.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
End Class