...
Public Class FormRptStockFecha
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        If gsError = "OK" Then
            If chkcontabilidad.Checked = True Then
                ...
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_ARTICULO_STKFISFEC1.rpt"
                gsRptPath = gsPathRpt
            ...
            Else
                ...
                If txtsublinea.Text = "0201" Then
                    gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_ARTICULO_STKFISFEC2.rpt"
                    gsRptPath = gsPathRpt
                    FormReportes.ShowDialog()
                Else
                    gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_ARTICULO_STKFISFEC.rpt"
                    gsRptPath = gsPathRpt
                    FormReportes.ShowDialog()
                End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_ARTICULO_STKFISFEC3.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
