...
Public Class FormRptDetRecep
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        If gsCode = "" Then
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_ELTBDETRECEPCOMP_SELROW.rpt"
        Else
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_ELTBDETRECEPCOMP_SELROW1.rpt"
        End If
        gsRptPath = gsPathRpt
