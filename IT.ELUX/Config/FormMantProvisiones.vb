...
#End Region
    ...
    Private Sub SaveData()
        ...
        PROVISIONESBE.NOM_CTCT = txtproveedor.Text
        ...
        If gsUser <> "CHOYOS" And gsUser <> "SISTEMA" And gsUser <> "JHUAYLLACAYAN" Then
            If sMes <= "diciembre" And Mid(txtmskfecprov.Text, 7, 4) <= DateTime.Now.ToString("yyyy") - 1 Then
        ...
        If gsError = "OK" Then
            ...
            If dgvtletras.Rows.Count > 0 Then
                ...
                If gsError3 = "OK" Then
                    ...
                    gsError2 = PROVISIONESBL.AsientoPR("Asiento", mesaño, m, RTrim(txtnumero.Text), txtser_doc_ref.Text, txtt_doc.Text, gsUser, txtproveedor.Text, dgvt_doc)
                    If gsError2 = "OK" Then
    ...
    Private Sub FormMantProvisiones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If (FormMain.cmbaño.Text = "2021" And FormMain.cmbmes.SelectedIndex <= 2) Or
            ...
            Case 1
                ...
                For Each row As DataRow In dtArticulo.Rows
                    dgvt_doc.Rows.Add(IIf(IsDBNull(row("T_DOC_REF")), "", row("T_DOC_REF")),'0
                                      ...
                                      IIf(IsDBNull(row("PESO")), "", row("PESO"))) '49
                ...
                If gsUser <> "SISTEMA" Or gsUser <> "CHOYOS" Then
                    If Mid(txtmskfecgene.Text, 7, 4) <= "2020" Or Mid(txtmskfecprov.Text, 7, 4) <= "2020" Then
