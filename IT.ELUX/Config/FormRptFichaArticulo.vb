        ...
        Else
            Try
                ...
                If Mid(txtcodart.Text, 1, 4) = "0223" Then
                    For Each archivos As String In My.Computer.FileSystem.GetFiles("\\192.168.1.5\Fichas Tecnicas\PDF FICHAS\PDF FICHAS\TWO", FileIO.SearchOption.SearchAllSubDirectories, "" & txtcodart.Text & " *.pdf")
                        rutaarchivo = archivos
                    Next
                ElseIf Mid(txtcodart.Text, 1, 4) = "0101" Then
                    For Each archivos As String In My.Computer.FileSystem.GetFiles("\\192.168.1.5\Fichas Tecnicas\PDF FICHAS\PDF FICHAS\FIBRA", FileIO.SearchOption.SearchAllSubDirectories, "" & txtcodart.Text & " *.pdf")
                        rutaarchivo = archivos
                    Next
                ElseIf Mid(txtcodart.Text, 1, 4) = "0217" Or Mid(txtcodart.Text, 1, 4) = "0216" Or Mid(txtcodart.Text, 1, 4) = "0218" Or
                    ...
                    For Each archivos As String In My.Computer.FileSystem.GetFiles("\\192.168.1.5\Fichas Tecnicas\PDF FICHAS\PDF FICHAS\ENSAMBLE", FileIO.SearchOption.SearchAllSubDirectories, "" & txtcodart.Text & " *.pdf")
                        rutaarchivo = archivos
                    Next
                End If
