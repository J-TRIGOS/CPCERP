Public Class FormRptRegVentas
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If cmbmoneda.SelectedIndex = -1 Or cmbmoneda.SelectedIndex = 0 Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_REG_VENTAS.rpt"
            gsRptPath = gsPathRpt
        ...
        Else
            ...
            Else
                gsRptArgs(8) = "01"
            End If
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_REG_VENTAS_MONEDA.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_LETRA_FACTURA.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
End Class