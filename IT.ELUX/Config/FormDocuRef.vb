                ...
                For Each row As DataRow In dt.Rows
                    ...
                    sPasar = REQUERIMIENTOBL.sReqAprob(IIf(IsDBNull(row("T_DOC_REF")), "", row("T_DOC_REF")), IIf(IsDBNull(row("SER_DOC_REF")), "", row("SER_DOC_REF")),
                                                       ...
                                                       IIf(IsDBNull(row("SER_DOC_REF1")), "", row("SER_DOC_REF1")),
                                                        IIf(IsDBNull(row("NRO_DOC_REF1")), "", row("NRO_DOC_REF1")), "20100279348")
                    If sPasar = "1" Then
                                ...
                                Else
                                    If txtt_doc.Text = "SOLM" Then
                                        ...
                                        For Each row As DataRow In dt.Rows
                                            ...
                                            End If
                                            Variable = ""
                                            'FormMantGuiaAlmacen.txtobserva1.Text = FormMantGuiaAlmacen.txtobserva1.Text & IIf(IsDBNull(row("T_DOC_REF1")), "", row("T_DOC_REF1")) & "-" & IIf(IsDBNull(row("SER_DOC_REF1")), "", row("SER_DOC_REF1")) & "-" & IIf(IsDBNull(row("NRO_DOC_REF1")), "", row("NRO_DOC_REF1")) & ","
                                            cont1 = cont1 + 1
                                            If cont1 = 1 Then
                        ...
                        For i = 0 To lvbusqueda1.Items.Count - 1
                            If lvbusqueda1.Items(i).Checked = True Then
                                ...
                                For Each row As DataRow In dt.Rows
                                    ...
                                    If FormMantGuiaAlmacen.dgvt_doc.Rows.Count > 0 Then
                                        For j = 0 To FormMantGuiaAlmacen.dgvt_doc.Rows.Count - 1
                                            'MsgBox(FormMantGuiaAlmacen.dgvt_doc.Rows(j).Cells("NRO_DOC_REF1").Value)
                                            If FormMantGuiaAlmacen.dgvt_doc.Rows(j).Cells("NRO_DOC_REF1").Value = IIf(IsDBNull(row("NRO_DOC_REF")), "", row("NRO_DOC_REF")) Then
                                                Variable = "1"
                                            End If
                                        Next
            ...
            If Label2.Text <> 0 Then
                For i = 0 To lvbusqueda1.Items.Count - 1
                    If lvbusqueda1.Items(i).Checked = True Then
                        ...
                        '                            IIf(IsDBNull(row("NRO_DOC_REF1")), "", row("NRO_DOC_REF1")), IIf(IsDBNull(row("ART_COD")), "", row("ART_COD")), "20100279348")
                    ...
                    For i = 0 To lvbusqueda.Items.Count - 1
                        If lvbusqueda.Items(i).Checked = True Then
                            ...
                            For Each row As DataRow In dt.Rows
                                ...
                                FormMantFacturacion.dgvt_doc.Rows.Add(FormMantFacturacion.txtt_doc.Text, FormMantFacturacion.cmb_serdoc.Text,
                                                             FormMantFacturacion.txtnumero.Text, lvbusqueda.Items(i).SubItems(0).Text, lvbusqueda.Items(i).SubItems(2).Text,
