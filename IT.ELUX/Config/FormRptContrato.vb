...
#End Region
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If rdbobrero.Checked Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTCONTRATO_OBRERO.rpt"
            gsRptPath = gsPathRpt
        ...
        ElseIf rdbempleado.Checked Then
            ...
            gsRptArgs(4) = txtc_costo2.Text
            gsRptArgs(5) = txtcontrato_prdo2.Text
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTCONTRATO_EMP.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        ElseIf rdbmotorizado.Checked Then
            ...
            gsRptArgs(4) = txtc_costo2.Text
            gsRptArgs(5) = txtcontrato_prdo2.Text
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTCONTRATO_MOTORIZADO.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        ElseIf rdbcomercial.Checked Then
            ...
            gsRptArgs(4) = txtc_costo2.Text
            gsRptArgs(5) = txtcontrato_prdo2.Text
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTCONTRATO_AREA_COMERCIAL.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
    ...
    Private Sub btnreporte2_Click(sender As Object, e As EventArgs) Handles btnreporte2.Click
        If rdbempleado.Checked Then
            ...
            Else
                MsgBox("Debe Seleccionar la Fecha")
            End If
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTCONTRATO_EMP2.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        ElseIf rdbobrero.Checked Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTCONTRATO_OBRERO2.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        ElseIf rdbcomercial.Checked Then
            ReDim gsRptArgs(4)
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTCONTRATO_VENTAS.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
    End Sub
