...
#Disable Warning BC42105 ' La función 'GetCmb' no devuelve un valor en todas las rutas de acceso de código. Puede producirse una excepción de referencia NULL en tiempo de ejecución cuando se use el resultado.
    ...
    Private Sub FormAlbaran_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DataGridView1.Columns.Add("CANTIDAD", "CANTIDAD")       '1
        DataGridView1.Columns.Add("TURNO", "TURNO")             '2
        DataGridView1.Columns.Add("FEC_PRO", "FEC.PRO")         '3
        DataGridView1.Columns.Add("FEC_VEN", "FEC.VEN")         '4

        DataGridView1.Columns.Add("PAQBAS", "PAQ.BAS")          '5
        DataGridView1.Columns.Add("PAQALT", "PAQ.ALT")          '6
        DataGridView1.Columns.Add("PAQPAL", "PAQ.PAL")          '7
        DataGridView1.Columns.Add("UNIPAQ", "UNI.PAQ")          '8
        DataGridView1.Columns.Add("UNIPAL", "UNI.PAL")          '9

        DataGridView1.Columns.Add("NUMPAL", "NUM.PAL")          '10
        gpCaption = "Aldebaran"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf gsError = "OK" Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_RPTALBARAN_PALLETS.rpt"
            gsRptPath = gsPathRpt
            ...
            gsRptArgs(1) = txtNro_two.Text
            gsRptArgs(2) = ComboBox2.Text
            gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_RPTALBARAN_PALLETS_PK.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
