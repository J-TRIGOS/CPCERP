...
Public Class FormELTBSTIEMJF
    ...
    Private Sub SaveData()
        ...
        ELTBSTIEMBE.OBSERVACIONRH = txtobsjf.Text
        ELTBSTIEMBE.USUARIO_VB_RH = gsCodUsr
        Dim ELTBDETSTIEMBE As New ELTBDETSTIEMBE
        Dim ELMVLOGSBE As New ELMVLOGSBE
        ELMVLOGSBE.log_codusu = gsCodUsr
        gsError = ELTBSTIEMBL.SaveRow(ELTBSTIEMBE, ELTBDETSTIEMBE, ELMVLOGSBE, "MJF", dgvtiemper)
        If gsError = "OK" Then
...
#End Region
    Private Sub GetData(ByVal sCode As String)
        ...
        Next
    End Sub
    Private Sub FormELTBSTIEMJF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim dt As DataTable
        'Dim nro As String
        bprimero = True
    ...
    Private Sub tsbForm_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles tsbForm.ItemClicked
        ...
        Select Case sFunc
            ...
            Case "Print"
                ...
                gsPathRpt = gsIpserver & "sistema\E.LUX\REPORTES\02\RPT02_SP_RPTELTBSTIEM_SELROW.rpt"
                gsRptPath = gsPathRpt
