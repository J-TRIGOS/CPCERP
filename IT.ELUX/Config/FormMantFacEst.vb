...
Imports IT.ELUX.BE
Imports IT.ELUX.BL
Public Class FormMantFacEst
    Private FACTURACIONBL As New FACTURACIONBL
    Private PROVISIONESBL As New PROVISIONESBL
    Private Sub FormMantFacEst_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub SaveData()
        ...
        Else
            FACTURACIONBE.X_D = ""
        End If
        gsError = FACTURACIONBL.SaveRowEst(FACTURACIONBE, ELMVLOGSBE, "ACTEST")
        If gsError = "OK" Then
    ...
    Private Sub FormMantFacEst_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Dispose()
    End Sub
End Class