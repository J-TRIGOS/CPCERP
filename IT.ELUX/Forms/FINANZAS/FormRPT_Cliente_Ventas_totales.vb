Public Class FormRPT_Cliente_Ventas_totales
    Private Sub btnsalir_Click(sender As Object, e As EventArgs) Handles btnsalir.Click
        Dispose()
    End Sub
    Private Sub FormRPT_Cliente_Ventas_totales_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        Dispose()
    End Sub

    Private Sub FormRPT_Cliente_Ventas_totales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_VENTAS_TOTALES_CLIENTES.rpt"
        gsRptPath = gsPathRpt
