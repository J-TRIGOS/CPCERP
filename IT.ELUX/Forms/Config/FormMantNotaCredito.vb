...
#End Region
    ...
    Private Sub SaveData()
        ...
        NOTACREDITOBE.PROVEEDOR = "155729857-2-2022"
        ...
        If gsError = "OK" Then
            ...
            'If gsError2 = "OK" Then
            MsgBox("Nota de Credito Creada", MsgBoxStyle.Information)
            'Else
        ...
        Try
            ...
            Select Case sFunc
                ...
                Case "Print"
                    ...
                    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_IMPRESION_NC.rpt"
                    gsRptPath = gsPathRpt
