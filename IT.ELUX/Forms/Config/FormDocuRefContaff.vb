...
Public Class FormDocuRefContaff
    ...
    Private Sub btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
        ...
        'MsgBox(lvbusqueda1.Items(0).SubItems(1).Text)
        'MsgBox(lvbusqueda1.Items(0).SubItems(2).Text)
        If lvbusqueda1.Items.Count = 0 Then
            ...
            Else
                For i = 0 To lvbusqueda1.Items.Count - 1
                    If lvbusqueda1.Items(i).Checked = True Then
                        Dim ELPRODUCCIONBE As New ELPRODUCCIONBE
                        Dim ELMVLOGSBE As New ELMVLOGSBE
                        'dt1 = ELORDEN_PROGRAMBL.listProdTot(lvbusqueda1.Items(0).SubItems(1).Text, lvbusqueda1.Items(0).SubItems(2).Text)
                        dt2 = ELORDEN_PROGRAMBL.listSolmTot(lvbusqueda1.Items(0).SubItems(1).Text, lvbusqueda1.Items(0).SubItems(2).Text)
                        dt3 = ELORDEN_PROGRAMBL.listFallTot(lvbusqueda1.Items(0).SubItems(1).Text, lvbusqueda1.Items(0).SubItems(2).Text)
                        dt4 = ELORDEN_PROGRAMBL.listReinTot(lvbusqueda1.Items(0).SubItems(1).Text, lvbusqueda1.Items(0).SubItems(2).Text)
                        'MsgBox(dt2.Rows(0).Item(0).ToString)
                        If dt2.Rows(0).Item(0).ToString <> 0 Then
                            MsgBox("Esta Orden ya cuenta con Solm de materiales declaradas")
                            Exit Sub
                        End If
                        If dt3.Rows(0).Item(0).ToString <> 0 Then
                            MsgBox("Esta Orden ya cuenta con mermas declaradas")
                            Exit Sub
                        End If
                        If dt4.Rows(0).Item(0).ToString <> 0 Then
                            MsgBox("Esta Orden ya cuenta con Reingresos Declarados")
                            Exit Sub
                        End If
                        ELPRODUCCIONBE.t_doc_ref = lvbusqueda1.Items(i).SubItems(0).Text
                        ELPRODUCCIONBE.ser_doc_ref = lvbusqueda1.Items(i).SubItems(1).Text
