...
Public Class FormRPTFCVentas_Sunat
    Private Sub FormRPTFCVentas_Sunat_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Ventas Facturas"
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_FACVEN_SELALL.rpt"
        gsRptPath = gsPathRpt
