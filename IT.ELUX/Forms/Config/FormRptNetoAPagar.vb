    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If cmbt_pago.SelectedIndex <> 3 Then
            ...
            Else
                gsRptArgs(3) = ""
            End If
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_NETO_APAGAR_MENSUAL.rpt"
            gsRptPath = gsPathRpt
            FormReportes.Show()
        Else
            ReDim gsRptArgs(1)
            ...
            Else
                gsRptArgs(1) = ""
            End If
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_NETO_APAGAR_QUINCENAL.rpt"
            gsRptPath = gsPathRpt
