...
#End Region
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If sOp = "0" Then
            ...
            Else
                gsRptArgs(10) = ""
            End If
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PRODUCCION_RP_ALL1.rpt"
                'Else
                '    'gsRptArgs(6) = txtlinea.Text
                '    gsRptArgs(7) = txtlote.Text
                '    gsRptArgs(8) = txtfardo.Text
                '    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PRODUCCION_RP_ALL.rpt"
                'End If
            ...
            If txtsublinea.TextLength = "4" Then
                ...
                gsRptArgs(8) = txtfardo.Text
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONTROL_PRODUCTIVIDAD1.rpt"
            Else
                'gsRptArgs(6) = ""
                gsRptArgs(6) = txtc_costo.Text
                gsRptArgs(7) = txtfardo.Text
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONTROL_PRODUCTIVIDAD.rpt"
            End If
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        If txtsublinea1.TextLength = "4" Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PRODUCCION_ORDEN1.rpt"
        Else
            gsRptArgs(5) = txtlinea1.Text
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PRODUCCION_ORDEN.rpt"
        End If
    ...
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button16.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONTROL_PRODUCTIVIDAD_DIA.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button18_Click(sender As Object, e As EventArgs) Handles Button18.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONTROL_PRODUCTIVIDAD_CCOSTO.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
