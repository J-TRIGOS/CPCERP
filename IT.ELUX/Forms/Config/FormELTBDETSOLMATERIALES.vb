...
Public Class FormELTBDETSOLMATERIALES
    ...
    Private Sub btnbuscar_Click(sender As Object, e As EventArgs) Handles btnbuscar.Click
        ...
        If gLinea <> Nothing And gSubLinea <> Nothing And gArt <> Nothing Then
            ...
            txtcodart.Text = gArt
            If rdbant.Checked = True Then
                If Mid(txtcodart.Text, 1, 4) <> "0401" And Mid(txtcodart.Text, 1, 4) <> "0402" And Mid(txtcodart.Text, 1, 4) <> "0403" And
                                    Mid(txtcodart.Text, 1, 4) <> "0404" And Mid(txtcodart.Text, 1, 4) <> "0405" And Mid(txtcodart.Text, 1, 4) <> "0406" And
                                    Mid(txtcodart.Text, 1, 4) <> "0407" And Mid(txtcodart.Text, 1, 4) <> "0408" And Mid(txtcodart.Text, 1, 4) <> "0409" And
                                    Mid(txtcodart.Text, 1, 4) <> "0501" And Mid(txtcodart.Text, 1, 4) <> "0502" And Mid(txtcodart.Text, 1, 4) <> "0503" And
                                    Mid(txtcodart.Text, 1, 4) <> "0504" And Mid(txtcodart.Text, 1, 4) <> "0505" And Mid(txtcodart.Text, 1, 4) <> "0506" And
                                    Mid(txtcodart.Text, 1, 4) <> "0507" And Mid(txtcodart.Text, 1, 4) <> "0508" And Mid(txtcodart.Text, 1, 4) <> "0510" And
                                    Mid(txtcodart.Text, 1, 4) <> "0511" And Mid(txtcodart.Text, 1, 4) <> "0512" And Mid(txtcodart.Text, 1, 4) <> "0513" And
                                    Mid(txtcodart.Text, 1, 4) <> "0514" And Mid(txtcodart.Text, 1, 4) <> "0515" And Mid(txtcodart.Text, 1, 4) <> "0520" And
                                    Mid(txtcodart.Text, 1, 4) <> "0521" And Mid(txtcodart.Text, 1, 4) <> "0531" And Mid(txtcodart.Text, 1, 4) <> "0532" And
                                    Mid(txtcodart.Text, 1, 4) <> "0533" And Mid(txtcodart.Text, 1, 4) <> "0534" And Mid(txtcodart.Text, 1, 4) <> "0535" And
                                    Mid(txtcodart.Text, 1, 4) <> "0536" And Mid(txtcodart.Text, 1, 4) <> "0540" And Mid(txtcodart.Text, 1, 4) <> "0541" And
                                    Mid(txtcodart.Text, 1, 4) <> "0542" And Mid(txtcodart.Text, 1, 4) <> "0543" And Mid(txtcodart.Text, 1, 4) <> "0544" And
                                    Mid(txtcodart.Text, 1, 4) <> "0545" And Mid(txtcodart.Text, 1, 4) <> "0546" And Mid(txtcodart.Text, 1, 4) <> "0547" And
                                    Mid(txtcodart.Text, 1, 4) <> "0548" And Mid(txtcodart.Text, 1, 4) <> "0550" And Mid(txtcodart.Text, 1, 4) <> "0551" And
                                    Mid(txtcodart.Text, 1, 4) <> "0552" And Mid(txtcodart.Text, 1, 4) <> "0553" And Mid(txtcodart.Text, 1, 4) <> "0554" And
                                    Mid(txtcodart.Text, 1, 4) <> "0555" And Mid(txtcodart.Text, 1, 4) <> "0556" And Mid(txtcodart.Text, 1, 4) <> "0557" And
                        ...
                        If icontador > 0 Then
                            If txtnumorden.Text <> Nothing Then
                                If rdbnew.Checked Then
                                    ...
                                    If Mid(cmbart.SelectedValue, 1, 4) = "0541" Then
                                        If MessageBox.Show("Agregar complementos", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                                            ...
                                            dtArticulo = ARTICULOBL.getListdgv2(cmbart.SelectedValue)
                                            For Each row As DataRow In dtArticulo.Rows
                                                FormMantELTBSOLMATERIALES.dgvt_doc.Rows.Add(FormMantELTBSOLMATERIALES.txtt_doc.Text, '0
                                                                  ...
                                                                  cmbaño.Text,'4
                                                                  txtnumorden.Text, '5
                                                                  (npdcantidad.Value * IIf(IsDBNull(row("CANTIDAD")), 1, row("CANTIDAD"))), '6
                                                                  Mid(IIf(IsDBNull(row("CODIGO")), "", row("CODIGO")), 1, 8),'7
                                                                  Mid(IIf(IsDBNull(row("CODIGO")), "", row("CODIGO")), 12), '8
                                                                  txtobservacion.Text, FormMantELTBSOLMATERIALES.dtpfecha.Text, ARTICULOBL.SelectUniMed(Mid(txtcodart.Text, 1, 8)),'11
                                                                  FormMantELTBSOLMATERIALES.cmbestado.Text, "", txtactivo.Text, '12,13,14
                                                                  txtc_costo.Text, txt_linea.Text) '15,16
                                            Next
