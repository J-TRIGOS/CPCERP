...
#End Region
    ...
    Private Sub btnbuscar_Click(sender As Object, e As EventArgs) Handles btnbuscar.Click
        ...
        If gLinea <> Nothing And gSubLinea <> Nothing And gArt <> Nothing Then
            If gLinea >= 600 And gLinea <> 1000 Then
    ...
    Private Sub dtpfec_gene_ValueChanged(sender As Object, e As EventArgs) Handles dtpfec_gene.ValueChanged
        If dtpfec_gene.Value > Date.Now Then
            dtpfec_gene.Value = Date.Now
        End If
    End Sub
End Class