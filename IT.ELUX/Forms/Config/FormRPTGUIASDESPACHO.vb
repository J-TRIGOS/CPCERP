...
#End Region
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If cmbt_mov.SelectedIndex = 3 Then
            ...
            '    gsRptArgs(9) = "0003"
            'End If
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_GUIASDESPACHO_E.rpt"
        ...
        Else
            ...
            ElseIf cmbdestino.SelectedIndex = 3 Then
                gsRptArgs(9) = "0003"
            End If
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_GUIASDESPACHO.rpt"
        End If
        gsRptPath = gsPathRpt
