...
Public Class FormDuplicarDetDocumento
    ...
    Private Sub btnduplicar_Click(sender As Object, e As EventArgs) Handles btnduplicar.Click
        ...
        ElseIf cmbtipo.Text = "PEAJE LINEA AMARILLA 11.80" Then
            ...
            DET_DOCUMENTOBE.T_DOC_REF = "01"
        ElseIf cmbtipo.Text = "PEAJE RUTAS DE LIMA S.A.C." Then
            DET_DOCUMENTOBE.TIPO_UNIDAD = "26"
            DET_DOCUMENTOBE.T_DOC_REF = "01"
        ElseIf cmbtipo.Text = "MAPFRE" Then
            DET_DOCUMENTOBE.TIPO_UNIDAD = "27"
            DET_DOCUMENTOBE.T_DOC_REF = "01"
        End If
    ...
    Private Sub npdestrrural_LostFocus(sender As Object, e As EventArgs) Handles npdestrrural.LostFocus
        ...
        If cmbtipo.Text = "LUZ STATKRAFT SOLES" Then 'LUZ STATKRAFT
            ...
            dgvt_doc.Rows.Add("0737401", 31, 0.14975845410628,
                              Math.Round(0.14975845410628 * ((npdmonto_total.Value)), 2), 'AFECTO
                              Math.Round(0.14975845410628 * (npdestrrural.Value), 2)) 'INAFECTO
    ...
    Private Sub cmbtipo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbtipo.SelectedIndexChanged
        ...
        ElseIf cmbtipo.Text = "PEAJE RUTAS DE LIMA S.A.C." Then
            txtruc.Text = "20550372640"
        ElseIf cmbtipo.Text = "MAPFRE" Then
            txtruc.Text = "20418896915"
        Else
            txtruc.Text = ""
    ...
    Private Sub txtnro_LostFocus(sender As Object, e As EventArgs) Handles txtnro.LostFocus
        ...
        ElseIf cmbtipo.Text = "PEAJE LINEA AMARILLA 10.40" Then 'txtruc.Text = "20523621212" Then
            dgvt_doc.Rows.Add("0742547", 3, 110 / 876,
                             Math.Round(8.8135593220338979, 2), 'AFECTO
                             0) '
        ElseIf cmbtipo.Text = "PEAJE RUTAS DE LIMA S.A.C." Then 'txtruc.Text = "20523621212" Then
            dgvt_doc.Rows.Add("0742547", 3, 110 / 876,
                             Math.Round(11.02, 2), 'AFECTO
                             0) 'INAFECTO
        End If
    ...
    Private Sub txtnro_KeyDown(sender As Object, e As KeyEventArgs) Handles txtnro.KeyDown
        If cmbtipo.Text = "PEAJE LINEA AMARILLA 11.40" Or cmbtipo.Text = "PEAJE LINEA AMARILLA 5" Or
           ...
           cmbtipo.Text = "PEAJE LINEA AMARILLA 11.80" Or cmbtipo.Text = "PEAJE RUTAS DE LIMA S.A.C." Then
            If e.KeyValue = Keys.Enter Then
                txt_fec_emi.Focus()
            End If
        ElseIf cmbtipo.Text = "PACIFICO SEGUROS EMPLEADOS" Or cmbtipo.Text = "PACIFICO SEGUROS OBREROS" Or cmbtipo.Text = "LUZ" Or
            cmbtipo.Text = "CREATECH INGENIERIA Y PROYECTO S.A.C." Or cmbtipo.Text = "MAPFRE" Then
            If e.KeyValue = Keys.Enter Then
    ...
    Private Sub npdmonto_total_LostFocus(sender As Object, e As EventArgs) Handles npdmonto_total.LostFocus
        ...
        ElseIf txtruc.Text = "20100152356" Then 'AGUA
            ...
            dgvt_doc.Rows.Add("0737400", 13, 0.0628019323671498,
                              ...
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737401", 31, 0.14975845410628,
                              Math.Round(0.14975845410628 * ((npdmonto_total.Value)), 6), 'AFECTO
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737402", 20, 0.0966183574879227,
        ...
        ElseIf cmbtipo.Text = "GASTOS REPRESENTACION" Then
            ...
            txt_fec_emi.Focus()
        ElseIf cmbtipo.Text = "MAPFRE" Then
            dgvt_doc.Rows.Add("0737399", 3, 0.0153,'AFECTO
                              Math.Round((0.0153 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737400", 29, 0.1506, 'AFECTO
                              Math.Round((0.1506 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737401", 14, 0.0727, 'AFECTO
                              Math.Round((0.0727 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737402", 18, 0.0935, 'AFECTO
                              Math.Round((0.0935 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737406", 22, 0.1143, 'AFECTO
                              Math.Round((0.1143 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737403", 2, 0.0105, 'AFECTO
                              Math.Round((0.0105 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737404", 26, 0.1167, 'AFECTO
                              Math.Round((0.1167 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737405", 5, 0.026, 'AFECTO
                              Math.Round((0.026 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737407", 11, 0.0571, 'AFECTO
                              Math.Round((0.0571 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737408", 5, 0.026, 'AFECTO
                              Math.Round((0.026 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737409", 7, 0.0364, 'AFECTO
                              Math.Round((0.0364 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737410", 19, 0.0987, 'AFECTO
                              Math.Round((0.0987 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737412", 8, 0.0415, 'AFECTO
                              Math.Round((0.0415 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737413", 5, 0.0156, 'AFECTO
                              Math.Round((0.0156 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737424", 3, 0.0053, 'AFECTO
                              Math.Round((0.0053 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737414", 1, 0.026, 'AFECTO
                              Math.Round((0.026 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737415", 2, 0.0105, 'AFECTO
                              Math.Round((0.0105 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737416", 2, 0.0104, 'AFECTO
                              Math.Round((0.0104 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737417", 3, 0.0156, 'AFECTO
                              Math.Round((0.0156 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737418", 5, 0.026, 'AFECTO
                              Math.Round((0.026 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737419", 4, 0.0208, 'AFECTO
                              Math.Round((0.0208 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            dgvt_doc.Rows.Add("0737420", 2, 0.0105, 'AFECTO
                              Math.Round((0.0105 * npdmonto_total.Value), 2),
                              0) 'INAFECTO
            txt_fec_emi.Focus()
        ElseIf cmbtipo.Text = "PEAJE LINEA AMARILLA 11.40 - 2" Then 'txtruc.Text = "20523621212" Then
