...
Public Class FormDuaCompra
    ...
    Private Sub btnimprimir_Click(sender As Object, e As EventArgs) Handles btnimprimir.Click
        ...
        Else
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_DECLARACIONJ.rpt"
            gsRptPath = gsPathRpt
    ...
    Private Sub FormDuaCompra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Dim rutaarchivo As String = "\\192.168.1.7\Fichas Tecnicas\PDF FICHAS\TWO\" & articulo & " *.pdf"
        'System.Diagnostics.Process.Start(rutaarchivo)
        'Try
        '    Dim articulo As String = "02230197"
        '    For Each archivos As String In My.Computer.FileSystem.GetFiles("\\192.168.1.7\Fichas Tecnicas\PDF FICHAS\TWO", FileIO.SearchOption.SearchAllSubDirectories, "" & articulo & " *.pdf")
        '        ListBox1.Items.Add(archivos)
        '    Next
        '    System.Diagnostics.Process.Start("\\192.168.1.7\Fichas Tecnicas\PDF FICHAS\TWO\02230197 FT 13 TAPA TWIST OFF 58 BESTE ERNTE P.7482 BPANI CON BOTON FULL.pdf")
