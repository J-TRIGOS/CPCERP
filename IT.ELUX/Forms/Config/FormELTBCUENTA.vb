...
Public Class FormELTBCUENTA
    ...
    Private Sub GetData(ByVal sCode As String, ByVal gsCode2 As String)
        ...
        For Each Registro In dtUsuario.Rows
            ...
            If IIf(IsDBNull(Registro("X_CCO")), "", Registro("X_CCO")) = "S" Then chk_x_cco.Checked = True Else chk_x_cco.Checked = False
            If IIf(IsDBNull(Registro("X_CTCT")), "", Registro("X_CTCT")) = "S" Then chk_ctct.Checked = True Else chk_ctct.Checked = False
            If IIf(IsDBNull(Registro("X_T_GASTO")), "", Registro("X_T_GASTO")) = "S" Then chk_x_tgasto.Checked = True Else chk_x_tgasto.Checked = False
            If IIf(IsDBNull(Registro("X_PROY")), "", Registro("X_PROY")) = "S" Then chk_x_proy.Checked = True Else chk_x_proy.Checked = False
            If IIf(IsDBNull(Registro("X_LINEA")), "", Registro("X_LINEA")) = "S" Then chk_x_linea.Checked = True Else chk_x_linea.Checked = False
            If IIf(IsDBNull(Registro("X_HCO")), "", Registro("X_HCO")) = "S" Then chk_hco.Checked = True Else chk_hco.Checked = False
            If IIf(IsDBNull(Registro("X_FUENTE")), "", Registro("X_FUENTE")) = "S" Then chk_xfuente.Checked = True Else chk_xfuente.Checked = False
            If IIf(IsDBNull(Registro("X_PADRE")), "", Registro("X_PADRE")) = "S" Then chk_xpadre.Checked = True Else chk_xpadre.Checked = False
            If IIf(IsDBNull(Registro("X_T_CONV")), "", Registro("X_T_CONV")) = "S" Then chk_t_conv.Checked = True Else chk_t_conv.Checked = False
            cmb_xtcmb.SelectedIndex = Registro("X_T_CMB")
            If IIf(IsDBNull(Registro("X_T_CONV")), "", Registro("X_T_SALDO")) = "S" Then chk_tsaldo.Checked = True Else chk_tsaldo.Checked = False
            If IIf(IsDBNull(Registro("X_T_CONV")), "", Registro("X_T_DOC")) = "S" Then chk_tdoc.Checked = True Else chk_tdoc.Checked = False
            txt_cta_des1.Text = IIf(IsDBNull(Registro("CTA_COD_DEST")), "", Registro("CTA_COD_DEST"))
            If IIf(IsDBNull(Registro("X_DIF_CMB")), "", Registro("X_DIF_CMB")) = "S" Then chk_x_difcmb.Checked = True Else chk_x_difcmb.Checked = False
            If IIf(IsDBNull(Registro("T_AJUSTE_INF_COD")), "", Registro("T_AJUSTE_INF_COD")) = "S" Then chk_t_ajuste.Checked = True Else chk_t_ajuste.Checked = False
            If IIf(IsDBNull(Registro("X_LABOR")), "", Registro("X_LABOR")) = "S" Then chk_xlabor.Checked = True Else chk_xlabor.Checked = False
            If IIf(IsDBNull(Registro("X_SUCU")), "", Registro("X_SUCU")) = "S" Then chk_xsucu.Checked = True Else chk_xsucu.Checked = False
                If IIf(IsDBNull(Registro("X_MODULO")), "", Registro("X_MODULO")) = "S" Then chk_x_modulo.Checked = True Else chk_x_modulo.Checked = False
                    If IIf(IsDBNull(Registro("X_BALANCE")), "", Registro("X_BALANCE")) = "S" Then chk_x_balance.Checked = True Else chk_x_balance.Checked = False
