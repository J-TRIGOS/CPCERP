...
#End Region
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        If c = 0 Then
            ...
            Else
                If chkprueba.Checked Then
                    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTORDEN_PROGRAM_SELROWOP.rpt"
                Else
        ...
        Else
            ...
            Next
            If chkprueba.Checked Then
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTORDEN_PROGRAM_SELROW1OP.rpt"
            Else
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTORDEN_PROGRAM_SELROW1.rpt"
            End If
