...
Imports IT.ELUX.BE
Imports IT.ELUX.BL
Public Class FormMantDetNotaCredito
    ...
    Private Sub btnagregar_Click(sender As Object, e As EventArgs) Handles btnagregar.Click
        ...
        If npdtcamb.Value = 0 Then
            ...
            Exit Sub
        End If
        If FormMantNotaCredito.txtmon.Text = "00" Then
            If npduprecio_venta.Value = 0 Then
                MsgBox("El Precio de Venta en Soles debe ser mayor a 0")
            End If
        ElseIf FormMantNotaCredito.txtmon.Text = "01" Then
            If npduprecio_venta.Value = 0 Then
        ...
        If gContador = 1 Then
            ...
            If npdcantidad.Value > 0 Then
                ...
                If gContador = 1 Then
                    ...
                    If FormMantNotaCredito.dgvt_doc.Rows.Count > 0 Then
                        For i = 0 To FormMantNotaCredito.dgvt_doc.Rows.Count - 1
                            If FormMantNotaCredito.dgvt_doc.Rows(i).Cells("ART_COD").Value = cmbart.SelectedValue Then
                    ...
                    If icontador > 0 Then
                        FormMantNotaCredito.dgvt_doc.Rows.Add(FormMantNotaCredito.txtt_doc.Text, '0
                                                              FormMantNotaCredito.cmb_serdoc.Text,'1
                                                              FormMantNotaCredito.txtnumero.Text, '2
                                                              tipo, '3
                                                              txtser_doc_ref1.Text,'4
                                                              txtnro_doc_ref1.Text & "-" & icontador, '5
                                                              FormMantNotaCredito.txtctct_cod.Text,'6 
                                                              npdcantidad.Value, '7
                                                              ...
                                                              FormMantNotaCredito.txtt_movinv.Text, '19
                                                              ...
                                                              txtigv_dimpor.Text, FormMantNotaCredito.txtmon.Text,  '28
                                                              FormMantNotaCredito.dtpfecha.Text, '29
                                                              gsUser, '30
                                                              cmbuni.SelectedValue, '31
                                                              FormMantNotaCredito.txtt_pago.Text, '30
                                                              FormMantNotaCredito.txtfor_ent.Text,'31
                                                              RTrim(DateTime.Now), "20100279348", '35
                                                              "", "", '37
                                                              "", "", '39
                                                              "0", "", txtdscto.Text, txtdscto_impor.Text, '43
                                                              txtdscto_dimpor.Text,'44
                                                              FormMantNotaCredito.cmbestado.Text,'45
                                                              txtdtpfec.Text,'46
                                                              txtnguia.Text, cmbsguia.Text) '47,48
                        Dispose()
                    Else
                        FormMantNotaCredito.dgvt_doc.Rows.Add(FormMantNotaCredito.txtt_doc.Text, '0
                                                              FormMantNotaCredito.cmb_serdoc.Text,'1
        ...
        ElseIf gContador = 0 Then
            If FormMantNotaCredito.txtmon.Text = "01" Then
            ...
            Dim sValor As String
            sValor = ARTICULOBL.SelectArt2(cmbart.SelectedValue)
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("CANTIDAD").Value = npdcantidad.Value '7
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("ART_COD").Value = cmbart.SelectedValue
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("NOM_ART").Value = sValor
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("OBSERVA").Value = txtobservacion.Text '16
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("TPRECIO_VENTA").Value = txttprecio_venta.Text
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("TPRECIO_DVENTA").Value = txttprecio_dventa.Text '19
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("IGV").Value = txtigv.Text
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("IGV_IMPOR").Value = txtigvimpor.Text
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("T_CAMB").Value = npdtcamb.Value
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("UPRECIO_VENTA").Value = npduprecio_venta.Value '23
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("UPRECIO_DVENTA").Value = npduprecio_dventa.Value '24
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("IGV_DIMPOR").Value = txtigv_dimpor.Text
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("UNIDAD").Value = cmbuni.SelectedValue '29
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("NRO_DOC_REF1").Value = txtnro_doc_ref1.Text '29
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("SER_DOC_REF1").Value = txtser_doc_ref1.Text '29
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("T_DOC_REF1").Value = tipo '29
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("NRO_DOCU2").Value = txtnguia.Text '37
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("CONFIGURACION").Value = cmbsguia.Text '38
            FormMantNotaCredito.dgvt_doc.Rows(FormMantNotaCredito.dgvt_doc.CurrentRow.Index).Cells("FECHA").Value = txtdtpfec.Text '36
            Dispose()
        End If
    End Sub
