Public Class FormRPTCalculoCTS
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If txtprdo1.Text > 162 Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPT_CALCULOCTS.rpt"
            gsRptPath = gsPathRpt
        ...
        Else
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPT_CALCULOCTS1.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
