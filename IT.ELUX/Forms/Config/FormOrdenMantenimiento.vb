    ...
    Private Sub FormOrdenMantenimiento_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case gnOpcion
            Case 0
                ...
                txtdocumento.Text = anho & " - " & ELORDEN_MANTBL.SelectMaxTransp(anho).PadLeft(8, "0")
    ...
    Private Sub tsbForm_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles tsbForm.ItemClicked
        ...
        Select Case sFunc
            ...
            Case "Print"
                ...
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTORDEN_MANT_SELROW.rpt"
                gsRptPath = gsPathRpt
