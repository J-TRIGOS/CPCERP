...
Public Class FormRptContaControlCobra
    ...
    Private Sub FormRptContaControlCobra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ' cmbmes1.SelectedItem = "Julio"
        'cmbmes2.SelectedIndex = Month(Date.Today)
        datFechaIni.Value.ToString("01/MM/yyyy")
        Dim dtActCTCTC As New DataTable
        dtActCTCTC = PROVISIONESBL.ActualizarCTCT(cmbaño.Text)
    End Sub
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        If cmb_venta1.SelectedIndex = -1 Or cmb_venta1.SelectedIndex = 0 Then
            gsRptArgs(6) = ""
        ElseIf cmb_venta1.SelectedIndex = 1 Then
            gsRptArgs(6) = "E"
        ElseIf cmb_venta1.SelectedIndex = 2 Then
            gsRptArgs(6) = "N"
        End If
        If cmb_venta2.SelectedIndex = -1 Or cmb_venta2.SelectedIndex = 0 Then
            gsRptArgs(7) = ""
        ElseIf cmb_venta2.SelectedIndex = 1 Then
            gsRptArgs(7) = "E"
        ElseIf cmb_venta2.SelectedIndex = 2 Then
            gsRptArgs(7) = "N"
        End If
        ...
        Else
            gsRptArgs(10) = "0"
        End If
        gsRptArgs(11) = txtvend.Text
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONTROL_COBRANZAS.rpt"
        gsRptPath = gsPathRpt
        FormReportes.Show()
    End Sub
    ...
    Private Sub btnreporte2_Click(sender As Object, e As EventArgs) Handles btnreporte2.Click
        ...
        If chkorigin.Checked Then
            ...
            ElseIf cmbt_venta4.SelectedIndex = 1 Then
                gsRptArgs(12) = ""
            End If
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_ESTADO_CUENTA_CLIENTEX.rpt"
        Else
            ReDim gsRptArgs(11)
            gsRptArgs(0) = Format(dtpfec3.Value, "yyyy/MM/dd")
            gsRptArgs(1) = Format(dtpfec4.Value, "yyyy/MM/dd")
            ...
            gsRptArgs(10) = "0"
            gsRptArgs(11) = ""
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_ESTADO_CUENTA_CLIENTE.rpt"
        End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        '    gsRptArgs(4) = "12"
        'End If
        gsRptArgs(3) = dtpDesde.Value.ToString("MM")
        gsRptArgs(4) = dtpHasta.Value.ToString("MM")
        ...
        Else
            gsRptArgs(9) = ""
        End If
        gsRptArgs(10) = dtpDesde.Value.ToString("dd/MM/yyyy")
        gsRptArgs(11) = dtpHasta.Value.ToString("dd/MM/yyyy")
        If gsRptArgs(10) = "01/01/" & cmbaño.Text And gsRptArgs(11) = "01/01/" & cmbaño.Text Then
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTPROG_DOCUPAGO2_AP.rpt"
        Else
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTPROG_DOCUPAGO2.rpt"
        End If
    ...
    Private Sub btnRpt2_Click(sender As Object, e As EventArgs) Handles btnRpt2.Click
        ReDim gsRptArgs(2)
        gsRptArgs(0) = datFechaIni.Value.ToString("dd/MM/yyyy")
        gsRptArgs(1) = datFechaFin.Value.ToString("dd/MM/yyyy")

        If cmbTipoDoc.SelectedIndex = -1 Then
            MsgBox("Seleccione Tipo de Documento")
            Exit Sub
        End If
        ...
        Select Case cmbTipoDoc.SelectedIndex
            ...
            Case 2
                gsRptArgs(2) = "00"
        End Select
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_DOC_ANULADOS.rpt"
        gsRptPath = gsPathRpt
        FormReportes.Show()
    End Sub
End Class