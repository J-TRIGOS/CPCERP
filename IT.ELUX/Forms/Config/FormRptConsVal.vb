...
#End Region
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONS_RESUANUAL_VAL.rpt"
        gsRptPath = gsPathRpt
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONSUMO_DETALLE_VAL.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button14.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONS_RESUCCOSTO_VAL.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button28_Click(sender As Object, e As EventArgs) Handles Button28.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONS_RESUCCOSTO_LINEA_VAL.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
