...
Imports IT.ELUX.BE
Imports IT.ELUX.BL
Public Class FormPrecioCompra01
    ...
    Private Sub SaveData()
        ...
        End Try
    End Sub
    Private Sub FormPrecioCompra01_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        npdprecio.Select()
    ...
    Private Sub FormPrecioCompra01_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Dispose()
    End Sub
