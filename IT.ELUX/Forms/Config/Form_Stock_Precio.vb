...
Public Class Form_Stock_Precio
    ...
    Private Sub btndiametro_Click(sender As Object, e As EventArgs) Handles btndiametro.Click
        ...
        Else
            ...
            'gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\01\RPT01_REPORTE_ARTICULO_PRECIO.rpt"
            'gsRptPath = gsPathRpt
    ...
    Private Sub btnaltura_Click(sender As Object, e As EventArgs) Handles btnaltura.Click
        ...
        Else
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\01\RPT01_REPORTE_ARTICULO_PRECIO_F.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
    End Sub
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        gsRptArgs = {}
        'ReDim gsRptArgs(0)
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PRECIOART_VEN01.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
