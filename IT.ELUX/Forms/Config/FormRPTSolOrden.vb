        ...
        Select Case sFunc
            ...
            Case "Print"
                If cmbTipo.SelectedIndex = 0 Then
                    ...
                    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_PRODUCCION_INDUSTRIALES.rpt"
                    gsRptPath = gsPathRpt
                ...
                ElseIf cmbTipo.SelectedIndex = 1 Then
                    ...
                    gsRptArgs(2) = nro
                    gsRptArgs(3) = Label4.Text
                    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_PRODUCCION_05GALONES.rpt"
                    gsRptPath = gsPathRpt
                    FormReportes.ShowDialog()
                    Exit Sub
