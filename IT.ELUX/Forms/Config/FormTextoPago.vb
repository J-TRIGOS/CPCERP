...
Public Class FormTextoPago
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        Else
            gsRptArgs(3) = ""
        End If
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_TEXTO_PAGO_MENSUAL.rpt"
        gsRptPath = gsPathRpt
        FormReportes.Show()
    End Sub

    Private Sub FormTextoPago_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        Dispose()
    End Sub
End Class