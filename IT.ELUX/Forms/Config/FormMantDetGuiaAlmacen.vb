...
Public Class FormMantDetGuiaAlmacen
    ...
    Private Sub FormMantDetRequerimiento_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If lbltmov.Text = "E24" Or lbltmov.Text = "S28" Then
            txttdoc.ReadOnly = True
            txttdoc.Text = "SALM"
            cmbSerDocArt.Visible = True
            cmbNroDoc.Visible = True
        ...
        If npdcantidad.Value > 0 Then
            ...
            If gContador = 1 Then
                ...
                If icontador > 0 Then
                    If lbltmov.Text = "E21" Or lbltmov.Text = "S28" Then
                        If txtndoc.Text = "" Or txtsdoc.Text = "" Or txttdoc.Text = "" Then
            ...
            Else
                ...
                Try
                    ...
                    If lbltmov.Text = "E24" Or lbltmov.Text = "S28" Then
                        FormMantGuiaAlmacen.dgvt_doc.Rows(FormMantGuiaAlmacen.dgvt_doc.CurrentRow.Index).Cells("TIPO_UNIDAD").Value = txttdoc.Text
                        FormMantGuiaAlmacen.dgvt_doc.Rows(FormMantGuiaAlmacen.dgvt_doc.CurrentRow.Index).Cells("CONFIGURACION").Value = cmbSerDocArt.Text
                        FormMantGuiaAlmacen.dgvt_doc.Rows(FormMantGuiaAlmacen.dgvt_doc.CurrentRow.Index).Cells("COMENTARIO").Value = cmbNroDoc.Text
                    End If
    ...
    Private Sub txtcodart_TextChanged(sender As Object, e As EventArgs) Handles txtcodart.TextChanged
        If bPrimero Then Exit Sub
        If lbltmov.Text = "E24" Or lbltmov.Text = "S28" Then
            If Len(txtcodart.Text) = 8 Then
                bPrimero = True
                'cmbSerDocArt.SelectedIndex = -1
                'cmbNroDoc.SelectedIndex = -1
                ''
                'cmbSerDocArt.DataSource = Nothing
                'cmbNroDoc.DataSource = Nothing.
                'cmbSerDocArt.Text = ""
                'cmbNroDoc.Text = ""
                'cmbNroDoc.Items.Clear()
                'cmbSerDocArt.Items.Clear()
                '
                '
                Dim dt As DataTable = ARTICULOBL.SelectSerArtD(txttdoc.Text, txtcodart.Text)
                If dt.Rows.Count > 0 Then
                    GetCmb("S_DOC", "lin_descri", dt, cmbSerDocArt)
                End If
                bPrimero = False
            End If
        End If
    ...
    Private Sub cmbSerDocArt_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbSerDocArt.SelectedIndexChanged
        If bPrimero Then Exit Sub
        If lbltmov.Text = "E24" Or lbltmov.Text = "S28" Then
            If Len(txtcodart.Text) = 8 And cmbSerDocArt.SelectedIndex > -1 Then
