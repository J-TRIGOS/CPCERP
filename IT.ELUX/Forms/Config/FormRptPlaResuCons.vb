...
Public Class FormRptPlaResuCons
    ...
    Private ELTBPLANILLAVWBL As New ELTBPLANILLAVWBL
...
#End Region
    ...
    Private Sub FormRptPlaResuCons_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            bprimero = False
        End If
        dgvtcod2.Columns.Add("CARGO", "CARGO") '0
        dgvtcod2.Columns.Add("CCO_COD", "CCO_COD") '1
        dgvtcod2.Columns.Add("COD_UBI", "COD_UBI") '2
        dgvtcod2.Columns.Add("CPTO_COD", "CPTO_COD") '3
        'dgvtcod2.Columns.Add("DIAS_DSCTO", "DIAS_DSCTO") '4
        dgvtcod2.Columns.Add("HORAS_EXTRAS", "HORAS_EXTRAS") '5
        dgvtcod2.Columns.Add("HORAS_NORMALES", "HORAS_NORMALES") '6
        dgvtcod2.Columns.Add("LINEA_COD", "LINEA_COD") '7
        dgvtcod2.Columns.Add("MONTO", "MONTO") '8
        'dgvtcod2.Columns.Add("NN", "NN") '9
        dgvtcod2.Columns.Add("NOM_TPAGO", "NOM_TPAGO") '10
        dgvtcod2.Columns.Add("PER_COD", "PER_COD") '11
        dgvtcod2.Columns.Add("PRDO_COD", "PRDO_COD") '12
        dgvtcod2.Columns.Add("SBASICO", "SBASICO") '13
        'dgvtcod2.Columns.Add("T_CPTO", "T_CPTO") '14
        dgvtcod2.Columns.Add("T_IMPRES", "T_IMPRES") '15
        dgvtcod2.Columns.Add("T_PAGO", "T_PAGO") '16
    End Sub
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PLLA_CCOSTO_RESU_CONSOLIDA.rpt"
        gsRptPath = gsPathRpt
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PLLA_PRDO_CCOSTO.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        ...
        Else
            gsRptArgs(8) = "GRA"
        End If
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PLLA_PRDO_CCOSTO_AREA.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button21_Click(sender As Object, e As EventArgs) Handles Button21.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PROV_GRATI.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button17_Click(sender As Object, e As EventArgs) Handles Button17.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PROV_CTS.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_PROV_VACACIONES.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button26_Click(sender As Object, e As EventArgs) Handles Button26.Click
        ...
        If txtcontrato_prdo8.TextLength > 0 And txtcontrato_prdo7.TextLength > 0 Then
            dt1 = ELTBPLANILLAVWBL.SelectRow(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                IIf(IsDBNull(row("CPTO_COD")), "", row("CPTO_COD")),'IIf(IsDBNull(row("DIAS_DSCTO")), "", row("DIAS_DSCTO")),
                IIf(IsDBNull(row("HORAS_EXTRAS")), "", row("HORAS_EXTRAS")),
                IIf(IsDBNull(row("HORAS_NORMALES")), "", row("HORAS_NORMALES")),
                IIf(IsDBNull(row("LINEA_COD")), "", row("LINEA_COD")),
                IIf(IsDBNull(row("MONTO")), "", row("MONTO")), 'IIf(IsDBNull(row("NN")), "", row("NN")),
                IIf(IsDBNull(row("NOM_TPAGO")), "", row("NOM_TPAGO")),
                IIf(IsDBNull(row("PER_COD")), "", row("PER_COD")),
                IIf(IsDBNull(row("PRDO")), "", row("PRDO")),
                IIf(IsDBNull(row("SBASICO")), "", row("SBASICO")),'IIf(IsDBNull(row("T_CPTO")), "", row("T_CPTO")),
                IIf(IsDBNull(row("T_IMPRES")), "", row("T_IMPRES")),
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow2(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow3(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow4(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow5(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow6(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow7(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow8(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow9(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
                ...
                IIf(IsDBNull(row("T_PAGO")), "", row("T_PAGO")))
            Next
            dt1 = ELTBPLANILLAVWBL.SelectRow10(txtcontrato_prdo7.Text)
            For Each row As DataRow In dt1.Rows
                dgvtcod2.Rows.Add(IIf(IsDBNull(row("CARGO")), "", row("CARGO")),
                IIf(IsDBNull(row("CCO_COD")), "", row("CCO_COD")),
                IIf(IsDBNull(row("COD_UBI")), "", row("COD_UBI")),
