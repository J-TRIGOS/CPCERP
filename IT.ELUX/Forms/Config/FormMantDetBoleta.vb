...
Imports IT.ELUX.BE
Imports IT.ELUX.BL
Public Class FormMantDetBoleta
    ...
    Private Sub btnagregar_Click(sender As Object, e As EventArgs) Handles btnagregar.Click
        ...
        If gContador = 1 Then
            ...
            If npdcantidad.Value > 0 Then
                ...
                If gContador = 1 Then
                    ...
                    If FormMantBoleta.dgvt_doc.Rows.Count > 0 Then
                        For i = 0 To FormMantBoleta.dgvt_doc.Rows.Count - 1
                            If FormMantBoleta.dgvt_doc.Rows(i).Cells("ART_COD").Value = cmbart.SelectedValue Then
                    ...
                    If icontador > 0 Then
                        FormMantBoleta.dgvt_doc.Rows.Add(FormMantBoleta.txtt_doc.Text, '0
                                                              FormMantBoleta.cmb_serdoc.Text,'1
                                                              FormMantBoleta.txtnumero.Text, '2
                                                              FormMantBoleta.txtt_doc.Text, '3
                                                              FormMantBoleta.cmb_serdoc.Text,'4
                                                              FormMantBoleta.txtnumero.Text & "-" & icontador, '5
                                                              FormMantBoleta.txtctct_cod.Text,'6 
                                                              npdcantidad.Value, '7
                                                              ...
                                                              FormMantBoleta.txtt_movinv.Text, '19
                                                              ...
                                                              txtigv_dimpor.Text, FormMantBoleta.txtmon.Text,  '28
                                                              FormMantBoleta.dtpfecha.Text, '29
                                                              gsUser, '30
                                                              ...
                                                              FormMantBoleta.cmbestado.Text) '45
                        Dispose()
                    Else
                        FormMantBoleta.dgvt_doc.Rows.Add(FormMantBoleta.txtt_doc.Text, '0
                                                              FormMantBoleta.cmb_serdoc.Text,'1
                                                              ...
                                                              "0", "", txtdscto.Text, txtdscto_impor.Text, '43
                                                              txtdscto_dimpor.Text,'44
                                                              FormMantBoleta.cmbestado.Text) '43
                        Dispose()
                    End If
                End If
            Else
        ...
        ElseIf gContador = 0 Then
            If FormMantBoleta.txtmon.Text = "01" Then
            ...
            Dim sValor As String
            sValor = ARTICULOBL.SelectArt2(cmbart.SelectedValue)
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("CANTIDAD").Value = npdcantidad.Value '7
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("ART_COD").Value = cmbart.SelectedValue
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("NOM_ART").Value = sValor
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("OBSERVA").Value = txtobservacion.Text '16
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("TPRECIO_VENTA").Value = txttprecio_venta.Text
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("TPRECIO_DVENTA").Value = txttprecio_dventa.Text '19
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("IGV").Value = txtigv.Text
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("IGV_IMPOR").Value = txtigvimpor.Text
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("T_CAMB").Value = npdtcamb.Value
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("UPRECIO_VENTA").Value = npduprecio_venta.Value '23
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("UPRECIO_DVENTA").Value = npduprecio_dventa.Value '24
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("IGV_DIMPOR").Value = txtigv_dimpor.Text
            FormMantBoleta.dgvt_doc.Rows(FormMantBoleta.dgvt_doc.CurrentRow.Index).Cells("UNIDAD").Value = cmbuni.SelectedValue '29
            Dispose()
        End If
    End Sub
