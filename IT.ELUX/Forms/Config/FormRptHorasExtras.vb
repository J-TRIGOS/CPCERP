...
Public Class FormRptHorasExtras
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        If rdbdet.Checked Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTELTBSTIEM_SELALL.rpt"
            gsRptPath = gsPathRpt
        ...
        ElseIf rdbboleta.Checked Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTELTBSTIEM_SELROWALL.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        Else
            dgvinc.Rows.Clear()
            ...
            'gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTPERASINC.rpt"
            'gsRptPath = gsPathRpt
            'FormReportes.ShowDialog()
