...
Imports IT.ELUX.BE
Imports IT.ELUX.BL
Public Class FormMantNDEst
    Private NOTADEBITOBL As New NOTADEBITOBL
    Private PROVISIONESBL As New PROVISIONESBL

    Private Sub FormMantNDEst_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FormMantNDEst_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Dispose()
    End Sub
    ...
    Private Sub SaveData()
        ...
        Else
            NOTADEBITOBE.X_D = ""
        End If
        gsError = NOTADEBITOBL.SaveRowEst(NOTADEBITOBE, ELMVLOGSBE, "ACTEST")
        If gsError = "OK" Then
