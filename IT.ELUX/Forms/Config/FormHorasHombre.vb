...
#End Region
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_HORASH_RESUANUAL.rpt"
        gsRptPath = gsPathRpt
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_HORASH_CCOSTO_DETALLE.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs) Handles Button15.Click
        ...
        If chkcco.Checked Then
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_HORAS_EXTRAS_PER_PRDO.rpt"
        Else
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_HORAS_EXTRAS_PER_PRDOX.rpt"
        End If
    ...
    Private Sub Button19_Click(sender As Object, e As EventArgs) Handles Button19.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_HORAS_PAGADAS_CCOSTO.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
End Class