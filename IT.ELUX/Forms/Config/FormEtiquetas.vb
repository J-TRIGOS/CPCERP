...
Public Class FormEtiquetas
    ...
    Private Sub FormEtiquetas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        GetDataRotulos(numReq, artCodReq)
        txtCodigo_LostFocus(sender, e)
    End Sub

    Private Sub procesarLote()
        Dim diaNatural = dtpfec1.Value.DayOfYear
        txt_lotenuevo.Text = diaNatural & dtpfec1.Value.ToString("yy") & "-" & cmbturno.SelectedIndex + 1
    End Sub
            ...
            Else
                ...
                If CheckBox1.Checked Then
                    If chkvis.Checked Then
                        ...
                        gsRptArgs(13) = ""
                        gsRptArgs(14) = ""
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA.rpt"
                        gsRptPath = gsPathRpt
                    ...
                    Else
                        ...
                        gsRptArgs(13) = ""
                        gsRptArgs(14) = ""
                        gsRptArgs(15) = txt_lotenuevo.Text
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_N_CANT.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                    End If
                Else
                    If chkvis.Checked Then
                        ...
                        gsRptArgs(14) = ""
                        gsRptArgs(15) = ""
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA1.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                    Else
                        ReDim gsRptArgs(15)
                        ...
                        gsRptArgs(14) = ""
                        gsRptArgs(15) = ""
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA1_N_CANT.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                    End If
                End If
            ...
            Else
                ...
                If CheckBox1.Checked Then
                    If chkvis.Checked Then
                        ...
                        gsRptArgs(14) = cmbaño2.Text & "-" & txtnroop.Text
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETAX.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                    Else
                        ReDim gsRptArgs(15)
                        ...
                        gsRptArgs(14) = cmbaño2.Text & "-" & txtnroop.Text
                        gsRptArgs(15) = txt_lotenuevo.Text
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_N_CANTX.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                    End If
                Else
                    If chkvis.Checked Then
                        ...
                        gsRptArgs(15) = cmbaño2.Text & "-" & txtnroop.Text
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA1X.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                    Else
                        ReDim gsRptArgs(15)
                        ...
                        gsRptArgs(14) = txtcantot.Text
                        gsRptArgs(15) = cmbaño2.Text & "-" & txtnroop.Text
                        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA1_N_CANTX.rpt"
                        gsRptPath = gsPathRpt
                        FormReportes.ShowDialog()
                    End If
                End If
    ...
    Private Sub btnreporteT_Click(sender As Object, e As EventArgs) Handles btnreporteT.Click
        ...
        Else
            ...
            If chknros.Checked = True Then
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_TWOX.rpt"
            Else
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_TWO2X.rpt"
            End If
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
    ...
    Private Sub btnreporteE_Click(sender As Object, e As EventArgs) Handles btnreporteE.Click
        ...
        gsRptArgs(13) = ""
        gsRptArgs(14) = cmbanhop.Text & "-" & txtnot.Text

        If CheckBox4.Checked = True Then
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_ENSAMX.rpt"
        Else
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_ENSAM2X.rpt"
        End If
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_MIGUEL.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        gsRptArgs(13) = txtoc1.Text
        gsRptArgs(14) = txtnro_orden1.Text
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_TWOXPK.rpt"
        'Else
        '    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_TWO2.rpt"
        'End If
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        Else
            ...
            If CheckBox1.Checked Then
                ...
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETAALBARAM.rpt"
                gsRptPath = gsPathRpt
                FormReportes.ShowDialog()
            Else
                ReDim gsRptArgs(13)
    ...
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button14.Click
        ...
        Else
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETAACTIVO.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        End If
    End Sub
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs) Handles Button15.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_SINART.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub Button17_Click(sender As Object, e As EventArgs) Handles Button17.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_INVENTARIO.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub txtnot_LostFocus(sender As Object, e As EventArgs) Handles txtnot.LostFocus
        txtnot.Text = txtnot.Text.PadLeft(9, "0")
    End Sub

    Private Sub GetDataRotulos(ByVal numero As String, ByVal art As String)
        Dim dtDataRotulos As New DataTable
        dtDataRotulos = ELETIQUETABL.BuscarDatosRotulo(numero, art)
        If dtDataRotulos.Rows.Count > 0 Then
            txtProveedor.Text = dtDataRotulos.Rows(0).Item(5)
            lblCtctCod.Text = dtDataRotulos.Rows(0).Item(4)
            txtNumOC.Text = dtDataRotulos.Rows(0).Item(1)
            txtSerOC.Text = dtDataRotulos.Rows(0).Item(0)
            txtCodigo.Text = art
            txtNomArticulo.Text = dtDataRotulos.Rows(0).Item(3)
        End If
    End Sub

    Private Sub btnImpRot_Click(sender As Object, e As EventArgs) Handles btnImpRot.Click
        If txtCantBulto.Text = "" Or txtCantBulto.Text = "0" Then
            MsgBox("Ingrese cantidad x Bulto")
            Exit Sub
        End If

        flagAccion = "N"
        Dim GUIASROTULOBE As New GUIASROTULOBE
        With GUIASROTULOBE
            .T_DOC_REF = tipGuia
            .SER_DOC_REF = serGuia
            .NRO_DOC_REF = numGUia
            .CANT_OC = txtCantGuia.Text
            .T_DOC_REF1 = "OREQ"
            .SER_DOC_REF1 = txtSerOC.Text
            .NRO_DOC_REF1 = txtNumOC.Text
            .CTCT_COD = lblCtctCod.Text
            .FEC_ING = dtpFecIngreso.Value.ToString("dd/MM/yyyy")
            .ART_COD = txtCodigo.Text
            .CANTIDAD = txtCantBulto.Text
            .BULTO = txtCantBulto.Text
            .TOTBULTOS = npdBultos.Value
            ' .FACTURA = txt_factura.Text
        End With
        Dim est = VerificarEtiquetas(GUIASROTULOBE)
        If est = False Then
            flagAccion = "N"
            gsError = ELETIQUETABL.SaveRowEtiqueta(GUIASROTULOBE, flagAccion)
        End If
        If est = True Then
            ReDim gsRptArgs(6)
            gsRptArgs(0) = GUIASROTULOBE.T_DOC_REF
            gsRptArgs(1) = GUIASROTULOBE.SER_DOC_REF
            gsRptArgs(2) = GUIASROTULOBE.NRO_DOC_REF
            gsRptArgs(3) = GUIASROTULOBE.T_DOC_REF1
            gsRptArgs(4) = GUIASROTULOBE.SER_DOC_REF1
            gsRptArgs(5) = GUIASROTULOBE.NRO_DOC_REF1
            gsRptArgs(6) = GUIASROTULOBE.ART_COD
    ...
    Private Sub txtCantBulto_Leave(sender As Object, e As EventArgs) Handles txtCantBulto.Leave
        If txtCantBulto.Text <> 0 Then
            Dim cantOc = txtCantGuia.Text
            Dim cantBulto = txtCantBulto.Text
            npdBultos.Value = cantOc / cantBulto
        End If
    End Sub

    Private Function VerificarEtiquetas(ByVal GUIASROTULOBE As GUIASROTULOBE) As Boolean
        Dim dtRegistros As New DataTable
        dtRegistros = ELETIQUETABL.VerificarRegistro(GUIASROTULOBE)
    ...
    Private Sub btnBuscarRot_Click(sender As Object, e As EventArgs) Handles btnBuscarRot.Click
        sBusAlm = "ROTULOSGUIA"
        Dim dt As New DataTable
        Dim frm As New FormBUSQUEDA
        bprimero = True
    ...
    Private Sub btnArt_Click(sender As Object, e As EventArgs) Handles btnArt.Click
        ...
        If gLinea <> Nothing And gSubLinea <> Nothing And gArt <> Nothing Then
            If gSubLinea = "0201" Then
                btnRotFar.Visible = True
            Else
                btnRotFar.Visible = False
            End If
            txtCodigo.Text = gArt
                txtNomArticulo.Text = gLinea3
                gLinea = Nothing
                gLinea3 = Nothing
                gSubLinea = Nothing
                gArt = Nothing
    ...
    Private Sub npdBultos_ValueChanged(sender As Object, e As EventArgs) Handles npdBultos.ValueChanged
        Dim bultos = npdBultos.Value
        txtCantBulto.Text = Math.Round(txtCantGuia.Text / bultos, 0)
    End Sub

    Private Sub txtCodigo_LostFocus(sender As Object, e As EventArgs) Handles txtCodigo.LostFocus
        If Mid(txtCodigo.Text, 1, 4) = "0201" And Len(txtCodigo.Text) = 8 Then
            btnRotFar.Visible = True
        Else
            btnRotFar.Visible = False
        End If
    ...
    Private Sub btnRotFar_Click(sender As Object, e As EventArgs) Handles btnRotFar.Click
        ...
        If est = True Then
            ...
            gsRptArgs(5) = GUIASROTULOBE.NRO_DOC_REF1
            gsRptArgs(6) = GUIASROTULOBE.ART_COD
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_GUIAS_FARDOS.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
        Else
            If gsError = "OK" Then
                ...
                gsRptArgs(5) = GUIASROTULOBE.NRO_DOC_REF1
                gsRptArgs(6) = GUIASROTULOBE.ART_COD
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_RPTETIQUETA_GUIAS_FARDO.rpt"
                gsRptPath = gsPathRpt
                FormReportes.ShowDialog()
            End If
        End If
