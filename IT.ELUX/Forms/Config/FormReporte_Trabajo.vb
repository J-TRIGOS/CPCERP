...
Public Class FormReporte_Trabajo
    ...
    Private Sub tsbForm_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles tsbForm.ItemClicked
        ...
        Select Case sFunc
            ...
            Case "Print"
                ...
                gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_RPTELTBMTIEM_SELROW.rpt"
                gsRptPath = gsPathRpt
    ...
    Private Sub SaveData()
        ...
        End If
        REPORTE_TRABAJOBE.FEC_GENE = dtpfec_gene.Value
        REPORTE_TRABAJOBE.PER_COD = txtdni.Text
        REPORTE_TRABAJOBE.FEC_DIA = Date.Now
    ...
    Private Sub dgvdiaper_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvdiaper.CellClick
        If dgvdiaper.Rows.Count > 0 Or dgvdiaper.CurrentRow.Index <> Nothing Then
