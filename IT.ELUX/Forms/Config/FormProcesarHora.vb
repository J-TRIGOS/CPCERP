...
Public Class FormProcesarHora
    ...
    Private Sub SaveData()
        ...
        Dim estFeriado = 0
        dtVacaciones = ELTBSTIEMBL.VerificarFeriado(dtpfecha.Value.ToString("dd/MM/yyyy"))
        If dtVacaciones.Rows(0).Item(0).ToString = 1 Then
            estFeriado = 1
        End If


        If dtpfecha.Value.DayOfWeek = 0 Or estFeriado = 1 Then
            ELTBSTIEMBE.OP = "1"
        Else
            ELTBSTIEMBE.OP = "0"
        End If
