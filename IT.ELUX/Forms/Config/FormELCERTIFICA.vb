...
Public Class FormELCERTIFICA
    ...
    Private Sub GetData(ByVal sTDoc As String, ByVal sSDoc As String, ByVal sNDoc As String)
        ...
        If lblclientenom1.Text = "HERSIL S.A. LABORATORIOS INDUSTRIALES FARMACEUTICOS" Then
        ...
        If dtUsuario.Rows.Count > 0 Then
            For Each Registro In dtUsuario.Rows
                ...
                txtOP.Text = IIf(IsDBNull(Registro("OP")), "", Registro("OP"))
        ...
        If dttapaplastic.Rows.Count > 0 Then
            For Each Regplastic In dttapaplastic.Rows
                ...
                txtx5.Text = IIf(IsDBNull(Regplastic("X5")), "", Regplastic("X5"))
        ...
        Else
            ...
            Else
                ...
                End If
                    ...
                    gsRptArgs(3) = txtFecIni.Text
                    If txtFecIni.Text = Nothing Then
                        gsRptArgs(4) = ""
                    Else
                        gsRptArgs(4) = "Fecha de Inicio:"
                    End If
        ...
        Else
            ...
            Else
                ...
                If gsError = "OK" Then
                    ...
                    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_DOCUMENTO_CALIDAD_EASY_PEEL.rpt " & ELCERTIFICABE.ser_doc_ref & " " & ELCERTIFICABE.nro_ser_doc
                    gsRptPath = gsPathRpt
                    FormReportes.ShowDialog()
                Else
                    FormMain.LblError.Text = gsError
        ...
        Else
            ...
            Else
                ...
                If gsError = "OK" Then
                    ...
                    gsRptArgs(1) = RTrim(cmbNroguia.SelectedItem)
                    gsRptArgs(2) = RTrim(txtnguia.Text)
                    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_DOCUMENTO_CALIDAD_TAPA_PLASTICA.rpt"
                    gsRptPath = gsPathRpt
                    FormReportes.ShowDialog()
                    'Dispose()
                    'Exit Sub
        ...
        Else
            ...
            Else
                ...
                If gsError = "OK" Then
                    ...
                    gsRptArgs(1) = RTrim(cmbNroguia.SelectedItem)
                    gsRptArgs(2) = RTrim(txtnguia.Text)
                    gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_DOCUMENTO_CALIDAD_TAPA_TELESCOPICAS.rpt"
                    gsRptPath = gsPathRpt
                    FormReportes.ShowDialog()
                    'Dispose()
                    'Exit Sub
    ...
    Private Sub txtproducto_LostFocus(sender As Object, e As EventArgs) Handles txtproducto.LostFocus
        ...
        If txtproducto.Text <> "" Then
            ...
            If Series.Length > 3 Then
                ...
                '--
                txtx2.Text = Series(13).Trim()
                txtx3.Text = Series(14).Trim()
                '--
...
#Disable Warning BC42105 ' La función 'GetCmb' no devuelve un valor en todas las rutas de acceso de código. Puede producirse una excepción de referencia NULL en tiempo de ejecución cuando se use el resultado.
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf gsError = "OK" Then
            ...
            gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_SP_ELTBACTA_TWOCAL.rpt"
            gsRptPath = gsPathRpt
            FormReportes.ShowDialog()
