...
#End Region
    Private Sub FormRPTConsumo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If gsMenuNodeId = "0404140000" Then
            Me.Text = "Consumo de Componentes"
        Else
    ...
    Private Sub btnreporte_Click(sender As Object, e As EventArgs) Handles btnreporte.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONSUMO_DETALLE.rpt"
        gsRptPath = gsPathRpt
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_CONSUMO_RESUANUAL.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub

    Private Sub reporteComponentesAnual()
        ReDim gsRptArgs(9)
        gsRptArgs(0) = cmbaño1.SelectedItem
        If cmbmes3.SelectedIndex = 1 Then
            gsRptArgs(1) = "01"
        ...
        gsRptArgs(8) = txtsublinea4.Text
        gsRptArgs(9) = txtproveedor1.Text
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_COMPONENTES_RESUANUAL.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
    ...
    Private Sub reporteComponentesDet()
        ReDim gsRptArgs(9)
        gsRptArgs(0) = cmbaño.SelectedItem
        If cmbmes1.SelectedIndex = 1 Then
            gsRptArgs(1) = "01"
        ...
        gsRptArgs(8) = txtsublinea2.Text
        gsRptArgs(9) = txtproveedor.Text
        gsPathRpt = gsIpserver & "sistema\E.ELUX\REPORTES\02\RPT02_COMPONENTES_DETALLE.rpt"
        gsRptPath = gsPathRpt
        FormReportes.ShowDialog()
    End Sub
End Class