Public Class ELTBPROGPAGOBE
    ...
    Private mFEC_PROG As Date
    Private mCod_cbco As String
    Private mEst_cobra As String
    Private mExt_banc As String
    Private mAct_flujo As String
    Private mFlujo_caja As String
    Private mANULAR As String
    Private mMonto_Pagar As String
    Private mMonto_DPagar As String
    ...
    Public Property FEC_PROG() As Date
        ...
        End Set
    End Property
    Public Property COD_CBCO() As String
        Get
            Return mCod_cbco
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Property EST_COBRA() As String
        Get
            Return mEst_cobra
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Property EXT_BANC() As String
        Get
            Return mExt_banc
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Property ACT_FLUJO() As String
        Get
            Return mAct_flujo
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Property FLUJO_CAJA() As String
        Get
            Return mFlujo_caja
        End Get
        Set(ByVal value As String)
    ...
    Public Property Monto_DPagar As String
        Get
            Return mMonto_DPagar
        End Get
        Set(value As String)
            mMonto_DPagar = value
        End Set
